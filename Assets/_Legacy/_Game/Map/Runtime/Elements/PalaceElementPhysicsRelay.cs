...
namespace StarNight.Map
{
    ...
    public sealed class PalaceElementPhysicsRelay : MonoBehaviour
    {
        [SerializeField] private PalaceElementDriver driver;

        public void Configure(PalaceElementDriver palaceDriver) => driver = palaceDriver;
