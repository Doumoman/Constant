...
public partial class InputManager : IManager
{
    ...
    public event Action OnDiaryPressed; // 도감 열기 (V)
    public event Action OnBombPressed; // 폭탄 설치 (B)
    public event Action OnRopePressed; // 로프 사용 (R)
    ...
    public void Init()
    {
        ...
        _controls.GamePlay.Diary.performed += HandleDiaryPerformed;
        _controls.GamePlay.Bomb.performed += HandleBombPerformed;
        _controls.GamePlay.Rope.performed += HandleRopePerformed;
    ...
    private void HandleDiaryPerformed(InputAction.CallbackContext context) => OnDiaryPressed?.Invoke();
    private void HandleBombPerformed(InputAction.CallbackContext context) => OnBombPressed?.Invoke();
    private void HandleRopePerformed(InputAction.CallbackContext context) => OnRopePressed?.Invoke();
