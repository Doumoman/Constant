...
public class TileMapData : MonoBehaviour
{
    ...
    /// <summary>런타임 절차 생성용 — 지형 스킨 프로필 주입.</summary>
    public void SetGroundProfile(SpriteShape profile) => _groundProfile = profile;
    ...
    private void CreateGroundShape(Transform parent, List<Vector2> loop)
    {
        ...
        ctrl.splineDetail = 4; // AddComponent 기본값 0이면 지오메트리가 아예 생성되지 않는다
