...
namespace StarNight.Map.Tests.EditMode.Sv5
{
    ...
    public sealed class Sv5RouteStatePolicyTests
    {
        ...
        public void T03_WeakForgeSealBossAndExitCandidatesAreRejectedWithoutStateMutation()
        {
            ...
            string start = Node(plan, Sv5WorldGraphRole.Start);
            string forge = Node(plan, Sv5WorldGraphRole.Forge);
            string seal = Node(plan, Sv5WorldGraphRole.Seal);
            string exit = Node(plan, Sv5WorldGraphRole.Exit);
        ...
        {
            Sv5CoreReservationPlan plan = Representative.Value;
            Sv5WorldGraphProof missingReturn = Sv5WorldGraphPlanner.Evaluate(plan.RouteSource.Graph.Nodes,
                plan.RouteSource.Graph.Edges.Where(edge => edge.TraversalCondition != "NORMAL_RESOURCE_RETURN"),
                new[] { Sv5WorldGraphRole.MooncoreOre, Sv5WorldGraphRole.CondensedCoefficientSap, Sv5WorldGraphRole.DeepStarYeast });
            Sv5RouteStateAnalysis reverse = Analyze(new[]
            {
                Candidate("REVERSE_SEAL_FORGE", Existing(Node(plan, Sv5WorldGraphRole.Seal)),
                    Existing(Node(plan, Sv5WorldGraphRole.Forge)), 7, true, false, false),
            });
        ...
        public void T05_IndividualShortcutsRemainPureAndSensitiveBypassIsDenied()
        {
            ...
            Sv5RouteStateAnalysis unknown = Analyze(new[]
            {
                Candidate("UNKNOWN", new Sv5RouteStateAnchor("UNKNOWN_ANCHOR", Sv5RouteStateAnchorKind.ExistingGraphNode),
                    Existing(Node(plan, Sv5WorldGraphRole.Start)), 0, false, false, false),
            });
        ...
        public void T06_CandidateSetsUseAnalysisNodesAndAreNotAcceptedByIndividualChecksAlone()
        {
            ...
            {
                Candidate("GENERAL_IN", Existing(Node(plan, Sv5WorldGraphRole.Start)), general, 0, false, false, false),
                Candidate("GENERAL_RESOURCE", general, Existing(Node(plan, Sv5WorldGraphRole.MooncoreOre)), 0, false, false, false),
            };
        ...
        {
            Sv5CoreReservationPlan plan = Representative.Value;
            Sv5WorldGraphPlan optional = Sv5RouteStatePolicy.EvaluateReturnPolicy(plan, Sv5WorldReturnShortcutPolicy.Optional);
        ...
        public void T08_ActualReviewContactsAreClassifiedFromPredicatesNotLabels()
        {
            ...
            {
                new Sv5SpecialWorldPoint(415, 301), new Sv5SpecialWorldPoint(491, 301), new Sv5SpecialWorldPoint(523, 134),
            }));
        ...
        private static Sv5RouteShortcutCandidate[] SafeCandidates()
        {
            ...
            return new[]
            {
                Candidate("SAFE_GENERAL_IN", Existing(Node(plan, Sv5WorldGraphRole.Start)), general, 0, false, false, false),
                Candidate("SAFE_GENERAL_RESOURCE", general, Existing(Node(plan, Sv5WorldGraphRole.MooncoreOre)), 0, false, false, false),
            };
        }
        ...
        private static Sv5RouteShortcutCandidate Candidate(string id, Sv5RouteStateAnchor from, Sv5RouteStateAnchor to,
            ...
            Sv5WorldGraphDirection.Right, resources, forge, seal, boss, "SV5_05_FOCUSED_TEST");
        ...
        private static string Node(Sv5CoreReservationPlan plan, Sv5WorldGraphRole role) =>
        ...
        {
            new Sv5RouteStateReviewContact(new Sv5SpecialWorldPoint(415, 301), new[]
            {
            ...
            new Sv5RouteStateReviewContact(new Sv5SpecialWorldPoint(491, 301), new[]
            {
                "74004c50147eb4af54c7c3beb9c82282fb0d23628aa3c2e2a588301c04e965f4",
                "a98881f4240397805efa4bd7a49fec0d564a271544864f5fdd66657aed45cdff",
            }),
            new Sv5RouteStateReviewContact(new Sv5SpecialWorldPoint(523, 134), new[]
            {
                "0fc428a59647d62495d286c4c25fd66afac209842182354729188041dc5796e3",
        ...
        private static IReadOnlyList<Sv5SpecialWorldPoint> ReadAirWitness()
        {
            ...
            var points = matches.Cast<Match>().Select(value => new Sv5SpecialWorldPoint(
        ...
        private static string Describe(IEnumerable<Sv5WorldGraphFailure> failures) =>
            string.Join(";", (failures ?? Array.Empty<Sv5WorldGraphFailure>()).Select(value => value.Code + ":" + value.Detail));
    }
}
#endif
