...
{
    public enum SpecialVillageDefinitionBuildErrorCode
    {
        MissingSource,
        UnexpectedSource,
        DuplicateSource,
    ...
    public sealed class SpecialVillageDefinitionBuildError
    {
        internal SpecialVillageDefinitionBuildError(
            string fileName,
            SpecialVillageDefinitionBuildErrorCode errorCode,
            string message,
        ...
        public SpecialVillageDefinitionBuildErrorCode ErrorCode { get; }
        ...
        internal static int Compare(
            SpecialVillageDefinitionBuildError left,
            SpecialVillageDefinitionBuildError right)
        {
