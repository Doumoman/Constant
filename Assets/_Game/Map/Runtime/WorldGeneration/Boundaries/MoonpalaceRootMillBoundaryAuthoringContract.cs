...
{
    public static class MoonpalaceRootMillBoundaryAuthoringContract
    {
        public const string PairRuleId = "PAIR_ROOT_MILL";
    ...
    public sealed class MoonpalaceRootMillBoundaryCandidateRow
    {
        public MoonpalaceRootMillBoundaryCandidateRow(
            string candidateId,
            string microchunkId,
            string biomeAId,
            string biomeBId,
    ...
    public sealed class MoonpalaceRootMillMicrochunkRow
    {
        public MoonpalaceRootMillMicrochunkRow(
            string microchunkId,
            int widthTiles,
            int heightTiles,
            string usageClass,
    ...
    public sealed class MoonpalaceRootMillTileRow
    {
        public MoonpalaceRootMillTileRow(
            string microchunkId,
            int localX,
            int localY,
            string groundCode,
    ...
    public sealed class MoonpalaceRootMillSocketRow
    {
        public MoonpalaceRootMillSocketRow(
            string microchunkId,
            string socketId,
            string side,
    ...
    public sealed class MoonpalaceRootMillBoundaryAuthoringData
    {
        public MoonpalaceRootMillBoundaryAuthoringData(
            IEnumerable<MoonpalaceRootMillBoundaryCandidateRow> candidates,
            IEnumerable<MoonpalaceRootMillMicrochunkRow> microchunks,
            IEnumerable<MoonpalaceRootMillTileRow> tiles,
            IEnumerable<MoonpalaceRootMillSocketRow> sockets,
        ...
        public IReadOnlyList<MoonpalaceRootMillBoundaryCandidateRow> Candidates { get; }
        public IReadOnlyList<MoonpalaceRootMillMicrochunkRow> Microchunks { get; }
        public IReadOnlyList<MoonpalaceRootMillTileRow> Tiles { get; }
        public IReadOnlyList<MoonpalaceRootMillSocketRow> Sockets { get; }
