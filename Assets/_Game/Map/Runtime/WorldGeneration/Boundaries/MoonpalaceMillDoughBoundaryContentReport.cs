...
{
    public sealed class MoonpalaceMillDoughBoundaryContentReport
    {
        internal MoonpalaceMillDoughBoundaryContentReport(
            ...
            int existingRowsModified,
            int otherPairRowsModified,
            int craterRootRowsModified,
            int craterMillRowsModified,
            int craterDoughRowsModified,
            int rootMillRowsModified,
            int rootDoughRowsModified,
