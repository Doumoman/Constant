...
```text
TASKS/MAP00_06_IMPLEMENT_COORDINATE_VALUE_TYPES.md
```
...
| MAP00_06_IMPLEMENT_COORDINATE_VALUE_TYPES | CURRENT |
...
- MAP00_05: `WorldGenConstants` 15개 const, constant tests 6/6 PASS, combined 16/16 PASS
...
현재는 `MAP00_06_IMPLEMENT_COORDINATE_VALUE_TYPES` 하나만 수행한다. 좌표 변환, bounds, `TryCreate`, CSV, 생성 알고리즘은 선행 구현하지 않는다.

MAP00_06이 PASS해도 MAP00_07을 자동 시작하지 않는다. STATUS FINALIZE는 MAP00_06을 COMPLETE로 바꾸고 Current Task를 NONE으로 만든 뒤 종료한다.
