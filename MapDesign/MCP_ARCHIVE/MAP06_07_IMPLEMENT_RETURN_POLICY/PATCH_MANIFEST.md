...
```yaml
patch_id: MAP06_07_IMPLEMENT_RETURN_POLICY
patch_version: 1.0
revision_note: MAP06_06 PASS/finalize 후 reciprocal Type0 internal BaseEdge의 all-cell returnability와 same opened attachment backtrack policy/witness를 기록하는 것만 연다. synthetic ReturnGate/SafeExit/device/socket/edge/recipe와 inactive-buffer 이후는 만들지 않는다. MAP06_07 production symbols를 허용하도록 phase-boundary negative assertions만 필요한 만큼 전진시킨다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER_RESULT.md
  exact_status: PASS
  sha256: 0acfcd73b6485e99a56dd4d44bff50f871548e266ed003607466961632ec449c
requires_previous_task_file:
  path: MapDesign/MCP/TASKS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER.md
  sha256: 8c8dd6a780b334edf7fb8c1276c1cc5d64332bf26f8c5ab9b69e9dabcb22a542
current_task_payload:
  path: PAYLOAD/TASKS/MAP06_07_IMPLEMENT_RETURN_POLICY.md
  sha256: 2ab50e5c150bc833395cd9e5f8acb017e8685d90f0b63d5cab394cf0e33b4956
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 74 COMPLETE / 1 CURRENT / 130 LOCKED
  map05_exit: APPROVED
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP06_07_IMPLEMENT_RETURN_POLICY.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP06_07_IMPLEMENT_RETURN_POLICY.md
    destination: MapDesign/MCP/TASKS/MAP06_07_IMPLEMENT_RETURN_POLICY.md
    mode: create
...
- MAP06_06 Result는 exact `PASS`, SHA-256 `0acfcd73b6485e99a56dd4d44bff50f871548e266ed003607466961632ec449c`다.
- 이전 MAP06_06 Task file SHA-256은 `8c8dd6a780b334edf7fb8c1276c1cc5d64332bf26f8c5ab9b69e9dabcb22a542`다.
- 새 MAP06_07 Task payload SHA-256은 `2ab50e5c150bc833395cd9e5f8acb017e8685d90f0b63d5cab394cf0e33b4956`다.
- MAP06_06은 COMPLETE 자격을 갖췄고 MAP06_07은 아직 `LOCKED / DO NOT START`였다.
- 205개 상태 행에서 MAP06_06까지 `COMPLETE`, MAP06_07 `CURRENT`, MAP06_08 이후는 `LOCKED`다.
- 새 Master/Status는 `74 COMPLETE / MAP06_07 CURRENT / 130 LOCKED`다.
- Type0/access/reward/growth digest chain과 regions/cells/assignments `12/39/12/12`를 입력 기준으로 보존한다.
- internal reciprocal BaseEdges `30`, attachment base-closed `12`, mandatory base-open `0`을 유지한다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3290`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
