...
```yaml
patch_id: MAP04_01_IMPLEMENT_BIOME_PATCH_MODELS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_11_MAP03_BATCH_AND_EXIT_TESTS_RESULT.md
  exact_status: PASS
  sha256: 6e870129778f62ceb13037b3f4c9f53ee55d37403b92685828f07767ae30df11
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_01_IMPLEMENT_BIOME_PATCH_MODELS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_01_IMPLEMENT_BIOME_PATCH_MODELS.md
    destination: MapDesign/MCP/TASKS/MAP04_01_IMPLEMENT_BIOME_PATCH_MODELS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~11은 `COMPLETE`, MAP04_01 이후는 `LOCKED`다.
- MAP03_11 Result는 exact `STATUS: PASS`, `MAP03 EXIT: APPROVED`, `MAP04 ENTRY: ELIGIBLE FOR SEPARATE PATCH`이고 SHA-256은 `6e870129778f62ceb13037b3f4c9f53ee55d37403b92685828f07767ae30df11`다.
- MAP03_11은 사용자 지정 1/10 profile에서 non-full `103/103`, 1,000-seed full `1/1`, 10,000-seed Village `2007/4945/3048`, determinism `102`, unresolved/invalid/retry `0/0/0`을 통과했다.
- MAP03_10까지의 runtime/editor/combined overlay `133/133 / 28/28 / 161/161`, MAP03_01~10 focused `2259/2259`, MAP02 phase `667/667`, visual `18/18`은 보존됐다.
- exact overlay cells/reservations/reserved/entries/witnesses/witness sectors/rules/diagnostic rows는 `169 / 7 / 8 / 6 / 4 / 20 / 6 / 16`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3071`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_11 COMPLETE/EXIT APPROVED와 MAP04_01 exact next를 기록한다.
- 새 status는 `46 COMPLETE / MAP04_01 CURRENT / 158 LOCKED`다.
