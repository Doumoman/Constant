...
```yaml
patch_id: MAP01_15_REPAIR_SPECIAL_MAP_BOOL_MATERIALIZATION
patch_version: 1.2
requires_status:
...
requires_csv_import_report:
  ...
  exact_sha256: 4ac0797c28e48c522a9cc0ff6840a43016de71bf58883cec685c7314700b5604
  schema_version: 1
  published: false
  error_count: 25
  warning_count: 0
...
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
    ...
    required_existing_sha256: 41dc7bdb9bdd838e04f3521674f4ac141e7519f22ef473b4c0c390e92b4802ef
...
- 기존 v1.1 Task 파일 SHA-256이 manifest 값과 일치할 때만 v1.2 payload로 교체한다. 다르면 `BLOCKED`다.
