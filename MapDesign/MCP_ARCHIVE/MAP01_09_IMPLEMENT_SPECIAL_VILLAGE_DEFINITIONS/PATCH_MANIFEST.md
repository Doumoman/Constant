...
```yaml
patch_id: MAP01_09_IMPLEMENT_SPECIAL_VILLAGE_DEFINITIONS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_08_IMPLEMENT_BIOME_BOUNDARY_DEFINITIONS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 326/326
  full_editmode: 369/369
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_09_IMPLEMENT_SPECIAL_VILLAGE_DEFINITIONS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_09_IMPLEMENT_SPECIAL_VILLAGE_DEFINITIONS.md
    destination: MapDesign/MCP/TASKS/MAP01_09_IMPLEMENT_SPECIAL_VILLAGE_DEFINITIONS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~08은 `COMPLETE`, MAP01_09 이후는 `LOCKED`다.
- MAP01_08 Result는 exact `STATUS: PASS`, definitions 36/36, parser 97/97, PK 32/32, validator 29/29, reader 31/31, schema 23/23, importer 9/9, architecture 10/10, targeted 326/326, full EditMode 369/369, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 MAP01_02~06 production C#은 MAP01_08에서 보존됐다.
- 새 Master는 MAP01_08 COMPLETE, MAP01_09 exact next를 기록한다.
- 새 status는 `18 COMPLETE / MAP01_09 CURRENT / 186 LOCKED`다.
