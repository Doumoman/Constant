...
```yaml
patch_id: MAP01_17_REPAIR_BATTERY_TYPED_REGISTRY
patch_version: 1.1
requires_status:
...
supplements_current_task: TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_1.md
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_1.md
    destination: MapDesign/MCP/TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_1.md
    mode: create
...
- MAP01_17 Result는 exact `STATUS: BLOCKED`, audit `34 PASS / 6 FAIL`; sole failure family는 Battery typed set 1 + required ID lookup 5다.
- production import는 exact 50 SUCCESS, ERROR/WARNING/FK 0, published/hash stable이고 Battery source PK는 `5/5`다.
- patch apply는 remediation addendum Task 하나만 create하며 Assets/C#/tests/CSV/meta/Result를 변경하지 않는다.
