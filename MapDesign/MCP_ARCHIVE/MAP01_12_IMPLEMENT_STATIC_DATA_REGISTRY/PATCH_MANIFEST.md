...
```yaml
patch_id: MAP01_12_IMPLEMENT_STATIC_DATA_REGISTRY
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_11_IMPLEMENT_FOREIGN_KEY_RESOLVER_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 492/492
  full_editmode: 535/535
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_12_IMPLEMENT_STATIC_DATA_REGISTRY.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_12_IMPLEMENT_STATIC_DATA_REGISTRY.md
    destination: MapDesign/MCP/TASKS/MAP01_12_IMPLEMENT_STATIC_DATA_REGISTRY.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~11은 `COMPLETE`, MAP01_12 이후는 `LOCKED`다.
- MAP01_11 Result는 exact `STATUS: PASS`, FK 54/54, targeted 492/492, full EditMode 535/535, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_11에서 보존됐다.
- 새 Master는 MAP01_11 COMPLETE, MAP01_12 exact next를 기록한다.
- 새 status는 `21 COMPLETE / MAP01_12 CURRENT / 183 LOCKED`다.
