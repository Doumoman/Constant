...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_10, MAP07_01 ~ MAP07_13, MAP08_01 ~ MAP08_07
실제 다음: MAP08_08_AUTHOR_CRATER_DOUGH_BOUNDARIES
...
MAP08 Phase: 7 COMPLETE / MAP08_08 CURRENT / 6 LOCKED
Auto Start: NO
```
...
| MAP08 | 14 | 7 COMPLETE / 1 CURRENT / 6 LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
| MAP11 | 14 | LOCKED |
| MAP12 | 14 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **98 COMPLETE / 1 CURRENT / 106 LOCKED** |
...
```text
NEXT  : MAP08_08_AUTHOR_CRATER_DOUGH_BOUNDARIES
THEN  : MAP08_09_AUTHOR_ROOT_MILL_BOUNDARIES (locked until MAP08_08 PASS)
LOCKED: MAP08_09 이후 전부
NO RUN: MAP08_07 및 이전 완료 Task 패키지
```

`MAP08_07_AUTHOR_CRATER_MILL_BOUNDARIES` Result는 STATUS `PASS`, SHA-256 `59cc98beaa374a319c656c50f0c5aaf26a4f25a29f591eb017bf21d4a9eb995a`로 검수했다. Installed/repaired MAP08_07 Task SHA-256은 `bf9085abb16be5c0bc736fa78b709fd32972f5903ba332622860d41d13aa4577`다. `PAIR_CRATER_MILL` 4 active candidates, 4 microchunks, 384 tile rows, 8 socket rows, MAP08 required `4140/4140`, MAP07 `5422/5422`, MAP06 `2746/2746`, MAP05 `1959/1959`, required subset `14267/14267`, compile/Console/warning `0/0/0`, global Assets meta `3693`, Map meta `574`, Authoring manifest `d55393e0d60e907462fe6e406b3b8705c98ff82c08b839bd64b54b5cd53808a2`다.

`MAP08_08_AUTHOR_CRATER_DOUGH_BOUNDARIES`는 이 패치에서 CURRENT로 열린다. 이 Task의 범위는 `PAIR_CRATER_DOUGH` MoonCrater↔MoonDough boundary 후보 matrix를 실제 Authoring CSV와 Runtime validator로 완성하는 것이다. `MAP08_09_AUTHOR_ROOT_MILL_BOUNDARIES`와 이후 pair authoring, generated CSV, MAP09+ 작업은 별도 PASS Result 전까지 열지 않는다.
