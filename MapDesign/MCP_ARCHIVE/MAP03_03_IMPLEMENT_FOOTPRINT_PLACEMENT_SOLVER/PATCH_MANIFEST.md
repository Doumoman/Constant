...
```yaml
patch_id: MAP03_03_IMPLEMENT_FOOTPRINT_PLACEMENT_SOLVER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1863/1863
  full_editmode: 1903/1903
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3005
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_03_IMPLEMENT_FOOTPRINT_PLACEMENT_SOLVER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_03_IMPLEMENT_FOOTPRINT_PLACEMENT_SOLVER.md
    destination: MapDesign/MCP/TASKS/MAP03_03_IMPLEMENT_FOOTPRINT_PLACEMENT_SOLVER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~02는 `COMPLETE`, MAP03_03 이후는 `LOCKED`다.
- MAP03_02 Result는 exact `STATUS: PASS`다.
- MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 1863/1863, full EditMode 1903/1903, compile/Console error·warning 0이다.
- immutable reservation models와 exact 6 groups / 933 raw candidates, Boss boundary origin `(12,12)` 보존, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3005`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_02 COMPLETE와 MAP03_03 exact next를 기록한다.
- 새 status는 `37 COMPLETE / MAP03_03 CURRENT / 167 LOCKED`다.
