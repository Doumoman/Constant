...
```yaml
patch_id: MAP02_01_IMPLEMENT_GENERATED_WORLD_DATA
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_project_baseline:
  ...
  targeted_editmode: 867/867
  full_editmode: 887/887
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP02_01_IMPLEMENT_GENERATED_WORLD_DATA.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP02_01_IMPLEMENT_GENERATED_WORLD_DATA.md
    destination: MapDesign/MCP/TASKS/MAP02_01_IMPLEMENT_GENERATED_WORLD_DATA.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~17은 `COMPLETE`, MAP02_01 이후는 `LOCKED`다.
- MAP01_17 Result는 exact `STATUS: PASS`, Battery 5/5, 필수 ID 25/25, CSV ERROR/WARNING/FK 0/0/0, audit 40/40, targeted 867/867, full EditMode 887/887이다.
- Authoring CSV/meta 50/50과 production pipeline은 MAP01_17에서 보존됐고 `MAP01 PHASE GATE APPROVED`다.
- 새 Master는 MAP01_17 COMPLETE, MAP02_01 exact next를 기록한다.
- 새 status는 `27 COMPLETE / MAP02_01 CURRENT / 177 LOCKED`다.
