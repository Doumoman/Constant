...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01
실제 다음: MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES
...
MAP03_01 Result: PASS 검수 완료
MAP03_02 패치: PACKAGED v1.0 / RESULT 대기
Auto Start: NO
```
...
| MAP03 | 11 | 1 COMPLETE / 1 CURRENT / 9 LOCKED — MAP03_02 NEXT |
| MAP04 | 11 | LOCKED |
| MAP05 | 11 | LOCKED |
| MAP06 | 10 | LOCKED |
| MAP07 | 13 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **36 COMPLETE / 1 CURRENT / 168 LOCKED** |
...
```text
NEXT  : MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES v1.0
THEN  : MAP03_03_IMPLEMENT_FOOTPRINT_PLACEMENT_SOLVER (separate patch only after MAP03_02 PASS)
LOCKED: MAP03_03 이후 전부
NO RUN: MAP03_01 및 이전 완료 Task 패키지
```

`MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS` Result는 exact `STATUS: PASS`로 검수했다. focused `81/81`, MAP02 phase `667/667`, targeted `1595/1595`, full EditMode `1635/1635`, compile/Console `0/0`, Authoring CSV/meta `50/50`, final Assets meta `2998`, duplicate GUID `0`, exact Assets changes `18`, existing modification `0`을 승인했다. 다음 exact Task는 `MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES` 하나이며 별도 v1.0 패치로만 연다. MAP03_02 PASS와 별도 finalize 전에는 MAP03_03을 만들거나 실행하지 않는다.
