...
```yaml
patch_id: MAP01_11_IMPLEMENT_FOREIGN_KEY_RESOLVER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_10_IMPLEMENT_MICROCHUNK_POPULATION_ITEM_DEFINITIONS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 438/438
  full_editmode: 481/481
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_11_IMPLEMENT_FOREIGN_KEY_RESOLVER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_11_IMPLEMENT_FOREIGN_KEY_RESOLVER.md
    destination: MapDesign/MCP/TASKS/MAP01_11_IMPLEMENT_FOREIGN_KEY_RESOLVER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~10은 `COMPLETE`, MAP01_11 이후는 `LOCKED`다.
- MAP01_10 Result는 exact `STATUS: PASS`, definitions 64/64, targeted 438/438, full EditMode 481/481, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_10에서 보존됐다.
- 새 Master는 MAP01_10 COMPLETE, MAP01_11 exact next를 기록한다.
- 새 status는 `20 COMPLETE / MAP01_11 CURRENT / 184 LOCKED`다.
