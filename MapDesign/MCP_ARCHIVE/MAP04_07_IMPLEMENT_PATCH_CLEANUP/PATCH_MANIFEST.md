...
```yaml
patch_id: MAP04_07_IMPLEMENT_PATCH_CLEANUP
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_06_IMPLEMENT_INTRUSION_PLACEMENT_RESULT.md
  exact_status: PASS
  sha256: 17be290682faf4a69716424bed7eb38fa32049a63f5406c17d0c89af128644ed
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_07_IMPLEMENT_PATCH_CLEANUP.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_07_IMPLEMENT_PATCH_CLEANUP.md
    destination: MapDesign/MCP/TASKS/MAP04_07_IMPLEMENT_PATCH_CLEANUP.md
    mode: create
...
- 205개 상태 행에서 MAP04_01~06까지 `COMPLETE`, MAP04_07 이후는 `LOCKED`다.
- MAP04_06 Result는 exact `PASS`, SHA-256 `17be290682faf4a69716424bed7eb38fa32049a63f5406c17d0c89af128644ed`다.
- MAP04_06 actual `671/671`, output `17 patches / 165 assigned / 4 reserved-unassigned`, RNG `1907->1912`, integrity/compile/change conflict `0`이다.
- current Assets meta `3118`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
- 새 Master/Status는 `52 COMPLETE / MAP04_07 CURRENT / 152 LOCKED`다.
