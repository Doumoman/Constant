...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_02
실제 다음: MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER
...
MAP06_03 패치: PACKAGED v1.0 / RESULT 대기 (optional region grower)
Auto Start: NO
```
...
| MAP06 | 10 | 2 COMPLETE / 1 CURRENT — MAP06_03 / 7 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
```text
NEXT  : MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER v1.0
THEN  : MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS (separate patch only after MAP06_03 PASS/finalize)
LOCKED: MAP06_04 이후 전부
NO RUN: MAP06_02 및 이전 완료 Task 패키지
```

`MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS` Result는 STATUS `PASS`, SHA-256 `69b6dbc5b379de297805ba8d9b3523779e26486a9244b3f2306523e70c9c123c`로 검수했다. 후보 열거는 raw probe `188`, accepted `51`, canonical digest `68b438c523645c2f6721fa0c104c3cd4c282076292cd2e035cd20a2b272aaee6`이며 OptionalAttachmentEnumeratorTests `202/202`, OptionalRegionModelsTests `194/194`, 기존 MAP05 aggregate `1959/1959`, actually executed required total `2355/2355`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3261`, Authoring CSV/meta `50/50`, duplicate GUID `0`을 승인했다. mandatory graph `47/96/48/47`과 Type4 U+D mandatory/L/R independent 규칙은 보존됐다. 다음 exact Task는 MAP06_03 하나다. MAP06_04는 MAP06_03 PASS/finalize 전까지 열지 않는다.
