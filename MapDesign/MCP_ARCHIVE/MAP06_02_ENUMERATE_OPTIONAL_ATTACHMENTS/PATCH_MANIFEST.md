...
```yaml
patch_id: MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS
patch_version: 1.0
revision_note: MAP06_01 PASS 및 Unity gate 완료 후 MAP06 optional attachment 후보 열거만 연다. MAP06_03 grower/mask/access/reward/return/inactive/validator/overlay/generated CSV는 만들지 않는다. MAP06_02 production symbols를 허용하도록 MAP05 boundary negative assertions만 필요한 만큼 전진시킨다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  ...
  exact_status: PASS
  sha256: 8d8f2b8bae5b08c9bf5fd258a225db89d16bffa5ca8faa058ef78ac02334442e
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 69 COMPLETE / 1 CURRENT / 135 LOCKED
  map05_exit: APPROVED
  map06_01_complete: TRUE
  map06_01_optional_region_models: 194/194
  map06_01_existing_map05_aggregate: 1959/1959
  map06_01_actual_required_total: 2153/2153
  map06_01_failed_skipped: 0/0
  map06_01_compile_console_warnings: 0/0/0
  map06_01_assets_meta_total: 3254
  map06_01_authoring_csv_meta: 50/50
  map06_01_duplicate_guid_groups: 0
...
- MAP06_01 Result는 exact `PASS`, SHA-256 `8d8f2b8bae5b08c9bf5fd258a225db89d16bffa5ca8faa058ef78ac02334442e`다.
- MAP06_01은 COMPLETE 자격을 갖췄고 MAP06_02는 아직 `LOCKED / DO NOT START`였다.
- 205개 상태 행에서 MAP06_01까지 `COMPLETE`, MAP06_02 `CURRENT`, MAP06_03 이후는 `LOCKED`다.
- 새 Master/Status는 `69 COMPLETE / MAP06_02 CURRENT / 135 LOCKED`다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3254`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
