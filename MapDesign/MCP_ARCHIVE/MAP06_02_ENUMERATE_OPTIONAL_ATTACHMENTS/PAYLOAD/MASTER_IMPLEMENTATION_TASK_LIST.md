...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01
실제 다음: MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS
...
MAP06_02 패치: PACKAGED v1.0 / RESULT 대기 (optional attachment enumeration)
Auto Start: NO
```
...
| MAP06 | 10 | 1 COMPLETE / 1 CURRENT — MAP06_02 / 8 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **69 COMPLETE / 1 CURRENT / 135 LOCKED** |
...
```text
NEXT  : MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS v1.0
THEN  : MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER (separate patch only after MAP06_02 PASS/finalize)
LOCKED: MAP06_03 이후 전부
NO RUN: MAP05_11 및 이전 완료 Task 패키지
```

`MAP06_01_IMPLEMENT_OPTIONAL_REGION_MODELS` Result는 STATUS `PASS`, SHA-256 `8d8f2b8bae5b08c9bf5fd258a225db89d16bffa5ca8faa058ef78ac02334442e`로 검수했다. OptionalRegionModelsTests `194/194`, 기존 MAP05 aggregate `1959/1959`, actually executed required total `2153/2153`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3254`, Authoring CSV/meta `50/50`, duplicate GUID `0`을 승인했다. Type4는 U+D를 보장하고 L/R을 실제 graph adjacency로 보존한다. 다음 exact Task는 MAP06_02 하나다. MAP06_03은 MAP06_02 PASS/finalize 전까지 열지 않는다.
