...
```yaml
patch_id: MAP04_05_IMPLEMENT_MULTI_SEED_BIOME_GROWER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_04_IMPLEMENT_SATELLITE_SEED_PLACER_RESULT.md
  exact_status: PASS
  sha256: 2706853d660845b059737c15488221f5bd5d68a5d02e0a3d6c65e9375464e334
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_05_IMPLEMENT_MULTI_SEED_BIOME_GROWER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_05_IMPLEMENT_MULTI_SEED_BIOME_GROWER.md
    destination: MapDesign/MCP/TASKS/MAP04_05_IMPLEMENT_MULTI_SEED_BIOME_GROWER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~11, MAP04_01~04는 `COMPLETE`, MAP04_05 이후는 `LOCKED`다.
- MAP04_04 Result는 exact `STATUS: PASS`이고 SHA-256은 `2706853d660845b059737c15488221f5bd5d68a5d02e0a3d6c65e9375464e334`다.
- MAP04_04 focused `141/141`, required regressions `458/458`, actually executed `599/599`, compile/Console/relevant warning `0/0/0`을 통과했다.
- targeted/full은 사용자 지정 감축 profile에 따라 executed PASS가 아니라 discovery/arithmetic `4345/4414`로 분리 기록됐다.
- MAP04_04 starter는 count `2/0/2/3`, `11 patches / 27 assigned / 142 unassigned / RNG 0->13`이다.
- MAP04_04는 exact 7 Runtime + 1 test + 8 matching meta만 만들었고 existing/unexpected Assets modification은 `0/0`이다.
- current Assets meta baseline은 `3101`, Authoring CSV/meta `50/50`, accepted legacy Editor folder meta `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP04_04 COMPLETE와 MAP04_05 exact next를 기록한다.
- 새 status는 `50 COMPLETE / MAP04_05 CURRENT / 154 LOCKED`다.
