...
```yaml
patch_id: MAP02_08_MAP02_EXIT_TESTS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP02_07_CREATE_WORLD_TOPOLOGY_OVERLAY_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1442/1442
  full_editmode: 1482/1482
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 2988
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP02_08_MAP02_EXIT_TESTS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP02_08_MAP02_EXIT_TESTS.md
    destination: MapDesign/MCP/TASKS/MAP02_08_MAP02_EXIT_TESTS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~07은 `COMPLETE`, MAP02_08 이후는 `LOCKED`다.
- MAP02_07 Result는 exact `STATUS: PASS`, focused 88/88, targeted 1442/1442, full EditMode 1482/1482, visual 12/12, compile/Console error·warning 0이다.
- immutable/shared topology overlay contracts와 기존 `56/103/90/84/77/97/54` regressions, Authoring CSV/meta 50/50, existing production/tests/asmdef는 보존됐다.
- current Assets meta baseline은 `2988`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP02_07 COMPLETE, MAP02_08 exact next를 기록한다.
- 새 status는 `34 COMPLETE / MAP02_08 CURRENT / 170 LOCKED`다.
