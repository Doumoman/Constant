...
```yaml
patch_id: MAP01_15_REPAIR_WORLD_ROUTE_SCHEMA_CONTRACTS
patch_version: 1.3
requires_status:
...
requires_csv_import_report:
  path: MapDesign/MCP/REPORTS/CsvImportReport.json
    exact_sha256: 6d4829a947d7bd8767de93ccc6daae1e1bda6b74dcc426dd641410ff9ceee51b
  schema_version: 1
  published: false
  error_count: 9
  warning_count: 0
...
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
    ...
    required_existing_sha256: d09f57322e190b5d357ec2c3bafd7bcf148bde03ec9340283670dcda96cea420
...
- 기존 v1.2 Task 파일 SHA-256이 manifest 값과 일치할 때만 v1.3 payload로 교체한다. 다르면 `BLOCKED`다.
