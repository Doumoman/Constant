...
```yaml
patch_id: MAP03_10_CREATE_SITE_RESERVATION_OVERLAY
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR_RESULT.md
  exact_status: PASS
  sha256: 3c6334097cceb13c6f62f7258e06f4114461f2ba901bd668cdcf328c3685cb4c
requires_project_baseline:
  ...
  targeted_editmode: 3612/3612
  full_editmode: 3652/3652
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3063
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_10_CREATE_SITE_RESERVATION_OVERLAY.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_10_CREATE_SITE_RESERVATION_OVERLAY.md
    destination: MapDesign/MCP/TASKS/MAP03_10_CREATE_SITE_RESERVATION_OVERLAY.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~09는 `COMPLETE`, MAP03_10 이후는 `LOCKED`다.
- MAP03_09 Result는 exact `STATUS: PASS`이고 SHA-256은 `3c6334097cceb13c6f62f7258e06f4114461f2ba901bd668cdcf328c3685cb4c`다.
- MAP03_09 focused 268/268, MAP03_08 focused 339/339, MAP03_07 focused 215/215, MAP03_06 focused 248/248, MAP03_05 focused 270/270, MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 3612/3612, full EditMode 3652/3652, compile/Console error·warning 0이다.
- exact final reservations/sector rows/reserved/unreserved/entries/witnesses/witness sectors/Core seeds/rules/violations/errors/RNG는 `7 / 169 / 8 / 161 / 6 / 4 / 20 / 4 / 6 / 0 / 0 / 0`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3063`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_09 COMPLETE와 MAP03_10 exact next를 기록한다.
- 새 status는 `44 COMPLETE / MAP03_10 CURRENT / 160 LOCKED`다.
