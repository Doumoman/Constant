...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_07
실제 다음: MAP03_08_IMPLEMENT_VILLAGE_RESERVATION
...
MAP03_01~07 Result: PASS 검수 완료
MAP03_08 패치: PACKAGED v1.0 / RESULT 대기
Auto Start: NO
```
...
| MAP03 | 11 | 7 COMPLETE / 1 CURRENT / 3 LOCKED — MAP03_08 NEXT |
| MAP04 | 11 | LOCKED |
| MAP05 | 11 | LOCKED |
| MAP06 | 10 | LOCKED |
| MAP07 | 13 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **42 COMPLETE / 1 CURRENT / 162 LOCKED** |
...
```text
NEXT  : MAP03_08_IMPLEMENT_VILLAGE_RESERVATION v1.0
THEN  : MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR (separate patch only after MAP03_08 PASS)
LOCKED: MAP03_09 이후 전부
NO RUN: MAP03_07 및 이전 완료 Task 패키지
```

`MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK` Result는 exact `STATUS: PASS`로 검수했다. focused `215/215`, previous backtracker/cost/distance/placement/candidate/model `248/248 / 270/270 / 239/239 / 170/170 / 268/268 / 81/81`, MAP02 phase `667/667`, starter selected/witnesses/total/overlap/RNG `6 / 4 / 20 / 0 / 3156->3156`, targeted `3005/3005`, full EditMode `3045/3045`, compile/Console `0/0`, Authoring CSV/meta `50/50`, final Assets meta `3045`, duplicate GUID `0`, exact Assets changes `18`, existing modification `0`을 승인했다. 다음 exact Task는 `MAP03_08_IMPLEMENT_VILLAGE_RESERVATION` 하나이며 별도 v1.0 패치로만 연다. MAP03_08 PASS와 별도 finalize 전에는 MAP03_09를 만들거나 실행하지 않는다.
