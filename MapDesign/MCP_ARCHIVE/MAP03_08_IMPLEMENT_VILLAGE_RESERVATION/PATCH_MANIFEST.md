...
```yaml
patch_id: MAP03_08_IMPLEMENT_VILLAGE_RESERVATION
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK_RESULT.md
  exact_status: PASS
  sha256: cdeecb64e96d162467cbefd9352e440a82484af4ce2fe36a372c31a870d5e1ac
requires_project_baseline:
  ...
  targeted_editmode: 3005/3005
  full_editmode: 3045/3045
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3045
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_08_IMPLEMENT_VILLAGE_RESERVATION.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_08_IMPLEMENT_VILLAGE_RESERVATION.md
    destination: MapDesign/MCP/TASKS/MAP03_08_IMPLEMENT_VILLAGE_RESERVATION.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~07은 `COMPLETE`, MAP03_08 이후는 `LOCKED`다.
- MAP03_07 Result는 exact `STATUS: PASS`이고 SHA-256은 `cdeecb64e96d162467cbefd9352e440a82484af4ce2fe36a372c31a870d5e1ac`다.
- MAP03_07 focused 215/215, MAP03_06 focused 248/248, MAP03_05 focused 270/270, MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 3005/3005, full EditMode 3045/3045, compile/Console error·warning 0이다.
- exact selected/capacity requirements/witnesses/witness sectors/overlap/RNG before-after는 `6 / 4 / 4 / 20 / 0 / 3156->3156`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3045`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_07 COMPLETE와 MAP03_08 exact next를 기록한다.
- 새 status는 `42 COMPLETE / MAP03_08 CURRENT / 162 LOCKED`다.
