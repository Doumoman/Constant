...
patch_version: 1.0
revision_note: MAP06_04 PASS/finalize 후 base-closed attachment boundary에 five access rules, perceptible clue, MAP06_06용 depth-based cost inputs를 immutable reservation으로 배정하는 것만 연다. concrete edge signature/socket/generated edge/CSV와 reward/return 이후는 만들지 않는다. MAP06_05 production symbols를 허용하도록 phase-boundary negative assertions만 필요한 만큼 전진시킨다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS_RESULT.md
  exact_status: PASS
  sha256: 7cfb055bb6cb1df24206b25a1a5f046936c7fbdf58bd4b307d476ead4f28ed7a
requires_previous_task_file:
  path: MapDesign/MCP/TASKS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS.md
  sha256: 320870304bc61d7414a10473978ae11472adefd88c6f8cd76bb6f909ac136cea
current_task_payload:
  path: PAYLOAD/TASKS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES.md
  sha256: d80cf04261811777b65b6c99ca8b7ae368fc39f4a895d024c6639ada5226c587
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 72 COMPLETE / 1 CURRENT / 132 LOCKED
  map05_exit: APPROVED
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES.md
    destination: MapDesign/MCP/TASKS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES.md
    mode: create
...
- MAP06_04 Result는 exact `PASS`, SHA-256 `7cfb055bb6cb1df24206b25a1a5f046936c7fbdf58bd4b307d476ead4f28ed7a`다.
- 이전 MAP06_04 Task file SHA-256은 `320870304bc61d7414a10473978ae11472adefd88c6f8cd76bb6f909ac136cea`다.
- 새 MAP06_05 Task payload SHA-256은 `d80cf04261811777b65b6c99ca8b7ae368fc39f4a895d024c6639ada5226c587`다.
- MAP06_04는 COMPLETE 자격을 갖췄고 MAP06_05는 아직 `LOCKED / DO NOT START`였다.
- 205개 상태 행에서 MAP06_04까지 `COMPLETE`, MAP06_05 `CURRENT`, MAP06_06 이후는 `LOCKED`다.
- 새 Master/Status는 `72 COMPLETE / MAP06_05 CURRENT / 132 LOCKED`다.
- Type0 assignment의 attachment boundary는 base-closed `12`, mandatory base-open `0`으로 보존한다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3274`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
