...
```yaml
patch_id: MAP04_03_IMPLEMENT_CORE_PATCH_GROWER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_02_INITIALIZE_CORE_PATCH_SEEDS_RESULT.md
  exact_status: PASS
  sha256: d10a2350723ebe2d47b26a89f59d0c605eb242fa9d1fe432e811bb39ee608ee8
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_03_IMPLEMENT_CORE_PATCH_GROWER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_03_IMPLEMENT_CORE_PATCH_GROWER.md
    destination: MapDesign/MCP/TASKS/MAP04_03_IMPLEMENT_CORE_PATCH_GROWER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~11, MAP04_01~02는 `COMPLETE`, MAP04_03 이후는 `LOCKED`다.
- MAP04_02 Result는 exact `STATUS: PASS`이고 SHA-256은 `d10a2350723ebe2d47b26a89f59d0c605eb242fa9d1fe432e811bb39ee608ee8`다.
- MAP04_02 focused `121/121`, required regressions `522/522`, actually executed `643/643`, compile/Console/relevant warning `0/0/0`을 통과했다.
- targeted/full은 사용자 지정 감축 profile에 따라 executed PASS가 아니라 discovery/arithmetic `4077/4146`으로 분리 기록됐다.
- MAP04_02 starter는 `4 patches / 4 bindings / 4 seed cells / 4 assigned / 165 unassigned / RNG 0`이다.
- MAP04_02는 exact 6 Runtime + 1 test + 7 matching meta만 만들었고 existing/unexpected Assets modification은 `0/0`이다.
- current Assets meta baseline은 `3086`, Authoring CSV/meta `50/50`, accepted legacy Editor folder meta `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP04_02 COMPLETE와 MAP04_03 exact next를 기록한다.
- 새 status는 `48 COMPLETE / MAP04_03 CURRENT / 156 LOCKED`다.
