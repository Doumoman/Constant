...
```text
TASKS/MAP00_07_IMPLEMENT_COORDINATE_CONVERSIONS.md
```
...
| MAP00_07_IMPLEMENT_COORDINATE_CONVERSIONS | CURRENT |
...
- MAP00_06: coordinate value types 4개, value type tests 12/12 PASS, combined 28/28 PASS
...
현재는 `MAP00_07_IMPLEMENT_COORDINATE_CONVERSIONS` 하나만 수행한다. exhaustive coordinate tests, debug view, CSV, 생성 알고리즘은 선행 구현하지 않는다.

MAP00_07이 PASS해도 MAP00_08을 자동 시작하지 않는다. STATUS FINALIZE는 MAP00_07을 COMPLETE로 바꾸고 Current Task를 NONE으로 만든 뒤 종료한다.
