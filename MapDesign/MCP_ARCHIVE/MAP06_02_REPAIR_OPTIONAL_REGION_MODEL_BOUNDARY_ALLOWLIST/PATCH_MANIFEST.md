...
patch_version: 1.1
revision_note: MAP06_02 FAIL 후 구현 산출물은 보존하고 OptionalRegionModelsTests의 phase-boundary assertion만 MAP06_02 허용 / MAP06_03+ 금지 기준으로 전진시킨다. MAP06_03은 시작하지 않는다.
requires_status:
  current_task: TASKS/MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS.md
  task_states:
...
requires_result:
  ...
  exact_status: FAIL
  sha256: a5c93b16d551ce999aebea014d37fc1ac0bbb0e6fea1c790ae97eb83175ee3c2
repair_basis:
  current_task_sha256: d1f39196c3897f54611185eb0ccd95d64e60ed60c1a4b96e03671c799e2f68f0
  revised_task_sha256: e87e9d55254243eea6ff590b84fb68225077890d454fde978b330a0f4ad805da
  failed_result_sha256: a5c93b16d551ce999aebea014d37fc1ac0bbb0e6fea1c790ae97eb83175ee3c2
  observed_optional_attachment_tests: 202/202 PASS
  observed_optional_region_models_tests: 193/194 PASS
  observed_failed_assertion: RuntimeSurfaceHasNoMutableStaticUnityEditorOrMap06_02PlusSymbols
  rejected_allowed_map06_02_symbol: OptionalAttachmentEnumerator
  existing_map05_aggregate: NOT_RUN_AFTER_REQUIRED_GATE_FAILURE
  candidate_raw_probes: 188
  candidate_accepted_count: 51
  candidate_digest: 68b438c523645c2f6721fa0c104c3cd4c282076292cd2e035cd20a2b272aaee6
  assets_meta_total: 3261
  new_csharp_meta: 7/7
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS.md
copy_operations:
  - source: PAYLOAD/TASKS/MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS.md
    destination: MapDesign/MCP/TASKS/MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS.md
    mode: replace_if_sha256_matches
    required_existing_sha256: d1f39196c3897f54611185eb0ccd95d64e60ed60c1a4b96e03671c799e2f68f0
...
- 적용 전 Current Task는 `TASKS/MAP06_02_ENUMERATE_OPTIONAL_ATTACHMENTS.md`다.
- 현재 Task SHA-256은 `d1f39196c3897f54611185eb0ccd95d64e60ed60c1a4b96e03671c799e2f68f0`다.
- 현재 MAP06_02 Result는 exact `FAIL`, SHA-256 `a5c93b16d551ce999aebea014d37fc1ac0bbb0e6fea1c790ae97eb83175ee3c2`다.
- 205개 상태 행에서 MAP06_01까지 `COMPLETE`, MAP06_02 `CURRENT`, MAP06_03 이후는 `LOCKED`다.
