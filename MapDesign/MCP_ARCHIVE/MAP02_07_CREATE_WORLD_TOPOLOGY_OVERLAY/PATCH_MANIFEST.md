...
```yaml
patch_id: MAP02_07_CREATE_WORLD_TOPOLOGY_OVERLAY
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP02_06_IMPLEMENT_SEED_MANIFEST_AND_REPLAY_RECORDER_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1374/1374
  full_editmode: 1394/1394
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 2981
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP02_07_CREATE_WORLD_TOPOLOGY_OVERLAY.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP02_07_CREATE_WORLD_TOPOLOGY_OVERLAY.md
    destination: MapDesign/MCP/TASKS/MAP02_07_CREATE_WORLD_TOPOLOGY_OVERLAY.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~06은 `COMPLETE`, MAP02_07 이후는 `LOCKED`다.
- MAP02_06 Result는 exact `STATUS: PASS`, focused 97/97, targeted 1374/1374, full EditMode 1394/1394, compile/Console error·warning 0이다.
- exact seed manifest/two-file replay/atomic publish/timing isolation contracts와 기존 `56/103/90/84/77/54` regressions, Authoring CSV/meta 50/50, existing production/tests/asmdef는 보존됐다.
- current Assets meta baseline은 `2981`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP02_06 COMPLETE, MAP02_07 exact next를 기록한다.
- 새 status는 `33 COMPLETE / MAP02_07 CURRENT / 171 LOCKED`다.
