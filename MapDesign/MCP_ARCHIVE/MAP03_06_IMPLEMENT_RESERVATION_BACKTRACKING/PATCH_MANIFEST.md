...
```yaml
patch_id: MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_05_IMPLEMENT_SITE_CANDIDATE_COST_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 2542/2542
  full_editmode: 2582/2582
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3027
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING.md
    destination: MapDesign/MCP/TASKS/MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~05는 `COMPLETE`, MAP03_06 이후는 `LOCKED`다.
- MAP03_05 Result는 exact `STATUS: PASS`다.
- MAP03_05 focused 270/270, MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 2542/2542, full EditMode 2582/2582, compile/Console error·warning 0이다.
- exact cost weights `10/25/1000/100/10000`, reference total `11145`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3027`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_05 COMPLETE와 MAP03_06 exact next를 기록한다.
- 새 status는 `40 COMPLETE / MAP03_06 CURRENT / 164 LOCKED`다.
