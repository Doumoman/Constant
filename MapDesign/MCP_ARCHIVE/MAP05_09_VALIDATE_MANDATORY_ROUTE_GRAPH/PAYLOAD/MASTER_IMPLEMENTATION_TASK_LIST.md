...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_08
실제 다음: MAP05_09_VALIDATE_MANDATORY_ROUTE_GRAPH
...
MAP05_08 Result: PASS 검수 완료 (mandatory route graph와 generated edge CSV 기록)
MAP05_09 패치: PACKAGED v1.0 / RESULT 대기 (mandatory route graph validation)
Auto Start: NO
```
...
| MAP05 | 11 | 8 COMPLETE / 1 CURRENT — MAP05_09 / 2 LOCKED |
| MAP06 | 10 | LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **65 COMPLETE / 1 CURRENT / 139 LOCKED** |
...
- [ ] `MAP05_09_VALIDATE_MANDATORY_ROUTE_GRAPH` — Type1/2/3/4 규칙(Type4 U/D 필수·L/R 선택), pair 대칭, terminal BFS, 독립 방문 후보를 검증한다.
...
```text
NEXT  : MAP05_09_VALIDATE_MANDATORY_ROUTE_GRAPH v1.0
THEN  : MAP05_10_CREATE_MANDATORY_ROUTE_OVERLAY (separate patch only after MAP05_09 PASS/finalize)
LOCKED: MAP05_10 이후 전부
NO RUN: MAP05_08 및 이전 완료 Task 패키지
```

`MAP05_08_BUILD_MANDATORY_ROUTE_GRAPH` Result는 STATUS `PASS`, SHA-256 `7c9820290ec5269222b8c145603a9ae53a2ea7f8d1df7b0ca6029e1be3647a99`로 검수했다. graph nodes/directed edges/route cells `47/96/47`, terminals `7/7`, loops `2/2`, actual `1991/1991`, compile/change conflict `0`, Assets meta `3229`를 승인했다. Type4는 U+D를 보장하고 L/R을 실제 graph adjacency로 보존한다. 다음 exact Task는 MAP05_09 하나다. MAP05_10은 MAP05_09 PASS/finalize 전까지 열지 않는다.
