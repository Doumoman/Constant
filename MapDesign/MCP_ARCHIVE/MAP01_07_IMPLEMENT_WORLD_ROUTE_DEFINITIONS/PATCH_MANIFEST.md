...
```yaml
patch_id: MAP01_07_IMPLEMENT_WORLD_ROUTE_DEFINITIONS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_06_IMPLEMENT_SCALAR_AND_LIST_PARSERS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 231/231
  full_editmode: 274/274
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_07_IMPLEMENT_WORLD_ROUTE_DEFINITIONS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_07_IMPLEMENT_WORLD_ROUTE_DEFINITIONS.md
    destination: MapDesign/MCP/TASKS/MAP01_07_IMPLEMENT_WORLD_ROUTE_DEFINITIONS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~06은 `COMPLETE`, MAP01_07 이후는 `LOCKED`다.
- MAP01_06 Result는 exact `STATUS: PASS`, parser 97/97, PK 32/32, validator 29/29, reader 31/31, schema 23/23, importer 9/9, architecture 10/10, targeted 231/231, full EditMode 274/274, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 MAP01_02/03/04/05 production C#은 MAP01_06에서 보존됐다.
- 새 Master는 MAP01_06 COMPLETE, MAP01_07 exact next를 기록한다.
- 새 status는 `16 COMPLETE / MAP01_07 CURRENT / 188 LOCKED`다.
