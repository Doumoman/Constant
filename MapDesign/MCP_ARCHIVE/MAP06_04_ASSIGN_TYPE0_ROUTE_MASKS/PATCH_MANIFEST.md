...
patch_version: 1.0
revision_note: MAP06_03 PASS/finalize 후 typed sector_route_masks 정의의 exact 12 registered Type0 rows와 optional topology 내부 BaseEdge의 per-cell exact mask assignment만 연다. attachment→mandatory boundary는 base-closed로 보존해 MAP06_05+ OptionalOverlayEdge에 넘긴다. Authoring/generated CSV와 mandatory graph/mask는 수정하지 않고 MAP06_05 access/clue 이후는 만들지 않는다. MAP06_04 production symbols를 허용하도록 phase-boundary negative assertions만 필요한 만큼 전진시킨다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER_RESULT.md
  exact_status: PASS
  sha256: 370a15f504d46492a591d064ee70dbc35d27b5b55ab4b621617aedae95d489b0
requires_previous_task_file:
  path: MapDesign/MCP/TASKS/MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER.md
  sha256: dbdde1bc53b615649c377c700a9c9d35f8de81baa2fcf79253f0e7d35974eb88
current_task_payload:
  path: PAYLOAD/TASKS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS.md
  sha256: 320870304bc61d7414a10473978ae11472adefd88c6f8cd76bb6f909ac136cea
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 71 COMPLETE / 1 CURRENT / 133 LOCKED
  map05_exit: APPROVED
  map06_01_complete: TRUE
  map06_02_complete: TRUE
  map06_03_complete: TRUE
  map06_03_optional_region_grower: 234/234
  map06_03_optional_attachment_enumerator: 202/202
  map06_03_optional_region_models: 194/194
  map06_03_existing_map05_aggregate: 1959/1959
  map06_03_actual_required_total: 2589/2589
  map06_03_failed_skipped: 0/0
  map06_03_compile_console_warnings: 0/0/0
  map06_03_assets_meta_total: 3266
  map06_03_authoring_csv_meta: 50/50
  map06_03_authoring_manifest_sha256: 4ffef6dbbea5151889d1c9114a500eba6cb54828ba47c9de508bad95dddc4ac3
  map06_03_duplicate_guid_groups: 0
  map06_03_growth_regions_cells: 12/39
  map06_03_growth_depth_buckets_1_2_3_4: 5/0/2/5
  map06_03_exact_one_bridges: 12/12
  map06_03_same_region_lr_through: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS.md
    destination: MapDesign/MCP/TASKS/MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS.md
    mode: create
...
- MAP06_03 Result는 exact `PASS`, SHA-256 `370a15f504d46492a591d064ee70dbc35d27b5b55ab4b621617aedae95d489b0`다.
- 이전 MAP06_03 Task file SHA-256은 `dbdde1bc53b615649c377c700a9c9d35f8de81baa2fcf79253f0e7d35974eb88`다.
- 새 MAP06_04 Task payload SHA-256은 `320870304bc61d7414a10473978ae11472adefd88c6f8cd76bb6f909ac136cea`다.
- MAP06_03은 COMPLETE 자격을 갖췄고 MAP06_04는 아직 `LOCKED / DO NOT START`였다.
- 205개 상태 행에서 MAP06_03까지 `COMPLETE`, MAP06_04 `CURRENT`, MAP06_05 이후는 `LOCKED`다.
- 새 Master/Status는 `71 COMPLETE / MAP06_04 CURRENT / 133 LOCKED`다.
- Type0는 exact 12 registered rows만 허용하고 모든 assignment는 `!(L&&R)`다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3266`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
