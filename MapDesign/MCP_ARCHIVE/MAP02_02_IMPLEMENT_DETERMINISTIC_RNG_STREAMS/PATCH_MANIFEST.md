...
```yaml
patch_id: MAP02_02_IMPLEMENT_DETERMINISTIC_RNG_STREAMS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP02_01_IMPLEMENT_GENERATED_WORLD_DATA_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 923/923
  full_editmode: 943/943
  compile_errors: 0
...
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP02_02_IMPLEMENT_DETERMINISTIC_RNG_STREAMS.md
    destination: MapDesign/MCP/TASKS/MAP02_02_IMPLEMENT_DETERMINISTIC_RNG_STREAMS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01은 `COMPLETE`, MAP02_02 이후는 `LOCKED`다.
- MAP02_01 Result는 exact `STATUS: PASS`, focused 56/56, targeted 923/923, full EditMode 943/943, compile/Console error·warning 0이다.
- exact 169-cell snapshot/13-column CSV v1과 Authoring CSV/meta 50/50, existing production/tests/asmdef는 MAP02_01에서 보존됐다.
- 새 Master는 MAP02_01 COMPLETE, MAP02_02 exact next를 기록한다.
- 새 status는 `28 COMPLETE / MAP02_02 CURRENT / 176 LOCKED`다.
