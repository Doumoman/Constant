...
```yaml
patch_id: MAP01_14_IMPLEMENT_ATOMIC_PUBLISH_AND_IMPORT_REPORT
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_13_IMPLEMENT_CONTENT_VERSION_HASH_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 616/616
  full_editmode: 636/636
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_14_IMPLEMENT_ATOMIC_PUBLISH_AND_IMPORT_REPORT.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_14_IMPLEMENT_ATOMIC_PUBLISH_AND_IMPORT_REPORT.md
    destination: MapDesign/MCP/TASKS/MAP01_14_IMPLEMENT_ATOMIC_PUBLISH_AND_IMPORT_REPORT.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~13은 `COMPLETE`, MAP01_14 이후는 `LOCKED`다.
- MAP01_13 Result는 exact `STATUS: PASS`, hash 54 cases, targeted 616/616, full EditMode 636/636, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_13에서 보존됐다.
- 새 Master는 MAP01_13 COMPLETE, MAP01_14 exact next를 기록한다.
- 새 status는 `23 COMPLETE / MAP01_14 CURRENT / 181 LOCKED`다.
