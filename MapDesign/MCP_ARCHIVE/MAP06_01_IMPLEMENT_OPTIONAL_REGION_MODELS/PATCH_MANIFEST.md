...
```yaml
patch_id: MAP06_01_IMPLEMENT_OPTIONAL_REGION_MODELS
patch_version: 1.0
revision_note: MAP05_11 PASS 및 MAP05 EXIT APPROVED 후 MAP06 Type0 optional region model 계약만 연다. Optional attachment/grower/mask/validator/overlay는 만들지 않는다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  ...
  exact_status: PASS
  sha256: 5fdd4354d1ceee50376c3a8cd535e391af4db10baa148c682cf70247b19b40ff
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 68 COMPLETE / 1 CURRENT / 136 LOCKED
  map05_exit: APPROVED
  map06_entry: ELIGIBLE_FOR_SEPARATE_PATCH
  map05_11_map05_focused: 1827/1827
  map05_11_exit_tests: 132/132
  map05_11_phase_aggregate: 1959/1959
  map05_11_seed_batch: 10000/10000
  map05_11_failed_skipped: 0/0
  map05_11_visual_game_scene_combined: 9/9/18
  map05_11_compile_console_warnings: 0/0/0
  ...
  map05_11_assets_meta_total: 3247
  approved_diagnostics_folder_meta: Assets/_Game/Tests/EditMode/Map/WorldGeneration/Diagnostics.meta
...
- MAP05_11 Result는 exact `PASS`, SHA-256 `5fdd4354d1ceee50376c3a8cd535e391af4db10baa148c682cf70247b19b40ff`다.
- MAP05 EXIT은 `APPROVED`, MAP06 ENTRY는 `ELIGIBLE FOR SEPARATE PATCH`다.
- 205개 상태 행에서 MAP05_11까지 `COMPLETE`, MAP06_01 `CURRENT`, MAP06_02 이후는 `LOCKED`다.
- 새 Master/Status는 `68 COMPLETE / MAP06_01 CURRENT / 136 LOCKED`다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3247`이고 approved Diagnostics folder meta branch를 보존한다.
- Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
