...
```yaml
patch_id: MAP04_04_IMPLEMENT_SATELLITE_SEED_PLACER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_03_IMPLEMENT_CORE_PATCH_GROWER_RESULT.md
  exact_status: PASS
  sha256: 6f4ace7b730f4df4662fcc4409d90d031555965bec47e1c62180a8632119280e
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_04_IMPLEMENT_SATELLITE_SEED_PLACER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_04_IMPLEMENT_SATELLITE_SEED_PLACER.md
    destination: MapDesign/MCP/TASKS/MAP04_04_IMPLEMENT_SATELLITE_SEED_PLACER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~11, MAP04_01~03은 `COMPLETE`, MAP04_04 이후는 `LOCKED`다.
- MAP04_03 Result는 exact `STATUS: PASS`이고 SHA-256은 `6f4ace7b730f4df4662fcc4409d90d031555965bec47e1c62180a8632119280e`다.
- MAP04_03 focused `127/127`, required regressions `443/443`, actually executed `570/570`, compile/Console/relevant warning `0/0/0`을 통과했다.
- targeted/full은 사용자 지정 감축 profile에 따라 executed PASS가 아니라 discovery/arithmetic `4204/4273`으로 분리 기록됐다.
- MAP04_03 starter는 `4 patches / 20 assigned / 149 unassigned / mandatory +16 / supplemental 0 / RNG 0`이다.
- MAP04_03은 exact 6 Runtime + 1 test + 7 matching meta만 만들었고 existing/unexpected Assets modification은 `0/0`이다.
- current Assets meta baseline은 `3093`, Authoring CSV/meta `50/50`, accepted legacy Editor folder meta `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP04_03 COMPLETE와 MAP04_04 exact next를 기록한다.
- 새 status는 `49 COMPLETE / MAP04_04 CURRENT / 155 LOCKED`다.
