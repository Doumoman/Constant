...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_09
실제 다음: MAP06_10_MAP06_OVERLAY_AND_EXIT_TESTS
...
MAP06_10 패치: PACKAGED v1.0 / RESULT 대기 (MAP06 overlay and exit tests)
Auto Start: NO
```
...
| MAP06 | 10 | 9 COMPLETE / 1 CURRENT — MAP06_10 |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **77 COMPLETE / 1 CURRENT / 127 LOCKED** |
...
```text
NEXT  : MAP06_10_MAP06_OVERLAY_AND_EXIT_TESTS v1.0
THEN  : MAP07_01_IMPLEMENT_MICROCHUNK_DEFINITION (separate patch only after MAP06_10 PASS/finalize)
LOCKED: MAP07 이후 전부
NO RUN: MAP06_09 및 이전 완료 Task 패키지
```

`MAP06_09_IMPLEMENT_OPTIONAL_REGION_VALIDATOR` Result는 STATUS `PASS`, SHA-256 `51a6f0dd621db698628ceef6ba7e7f2f18988b213ad564e7b35e00c52041d62a`로 검수했다. validation status `Valid`, issues `0`, canonical validation digest `1180f6a784b29739a2ca640d2c45398066ec7e636a8cb69ee307315cc20cc84e`, world/mandatory/regions/Type0 `169/47/12/39`, access/clue/reward `12/12/12`, mandatory reward `0`, return assignments/returnable/non-returnable `12/39/0`, inactive `78`, DecorativeBoundary/InteriorInactive `52/26`, protected union `91`, approved adapter overlap `3`, open-edge-to-inactive `0`, Type0 L+R-open `0`을 승인했다. OptionalRegionValidatorTests `321/321`, preserved accounting `3984/3984`, required task accounting `4305/4305`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3311`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다. Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_10 하나다. MAP07_01은 MAP06_10 PASS/finalize 전까지 열지 않는다.
