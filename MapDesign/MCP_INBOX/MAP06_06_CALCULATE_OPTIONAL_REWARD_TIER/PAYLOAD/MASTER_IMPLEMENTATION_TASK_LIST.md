...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_05
실제 다음: MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER
...
MAP06_06 패치: PACKAGED v1.0 / RESULT 대기 (optional reward score and tier)
Auto Start: NO
```
...
| MAP06 | 10 | 5 COMPLETE / 1 CURRENT — MAP06_06 / 4 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **73 COMPLETE / 1 CURRENT / 131 LOCKED** |
...
```text
NEXT  : MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER v1.0
THEN  : MAP06_07_IMPLEMENT_RETURN_POLICY (separate patch only after MAP06_06 PASS/finalize)
LOCKED: MAP06_07 이후 전부
NO RUN: MAP06_05 및 이전 완료 Task 패키지
```

`MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES` Result는 STATUS `PASS`, SHA-256 `0f8d8ba09d8c6f36cd75a8bdcdc808eb00bcc1d63031981425a580a64d481630`로 검수했다. assignments/clues/perceptible `12/12/12`, access distribution Basic/Tool/Environment/Explosive/Hidden `3/3/2/2/2`, tool Pickaxe/Shovel/Rope `1/1/1`, hidden Crack/Light/Sound `1/1/0`, explosive preview `2`, attachment base-closed `12`, mandatory base-open `0`, canonical digest `5268b7ed2342f197fb5717c85dbfdb8e51b3c520c217ecf93ad14dc944ecf74f`를 승인했다. OptionalAccessRuleAssignerTests `289/289`, Type0 `257/257`, MAP06 prior combined `630/630`, MAP05 aggregate `1959/1959`, actual total `3135/3135`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3283`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다. reward tier/item/return/inactive/validator/overlay/generated CSV는 생성되지 않았고 Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_06 하나다. MAP06_07은 MAP06_06 PASS/finalize 전까지 열지 않는다.
