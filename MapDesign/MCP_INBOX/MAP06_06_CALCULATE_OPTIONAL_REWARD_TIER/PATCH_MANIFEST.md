...
```yaml
patch_id: MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER
patch_version: 1.0
revision_note: MAP06_05 PASS/finalize 후 immutable Type0/access source-chain에서 depth*2 + tool + fuel/10 + hidden score와 existing Low/Medium/High/Unique tier reservation을 계산하는 것만 연다. actual reward ID/item/pool/quantity/spawn 및 return 이후는 만들지 않는다. MAP06_06 production symbols를 허용하도록 phase-boundary negative assertions만 필요한 만큼 전진시킨다.
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES_RESULT.md
  exact_status: PASS
  sha256: 0f8d8ba09d8c6f36cd75a8bdcdc808eb00bcc1d63031981425a580a64d481630
requires_previous_task_file:
  path: MapDesign/MCP/TASKS/MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES.md
  sha256: d80cf04261811777b65b6c99ca8b7ae368fc39f4a895d024c6639ada5226c587
current_task_payload:
  path: PAYLOAD/TASKS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER.md
  sha256: 8c8dd6a780b334edf7fb8c1276c1cc5d64332bf26f8c5ab9b69e9dabcb22a542
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 205
  status_counts_after_apply: 73 COMPLETE / 1 CURRENT / 131 LOCKED
  map05_exit: APPROVED
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER.md
    destination: MapDesign/MCP/TASKS/MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER.md
    mode: create
...
- MAP06_05 Result는 exact `PASS`, SHA-256 `0f8d8ba09d8c6f36cd75a8bdcdc808eb00bcc1d63031981425a580a64d481630`이다.
- 이전 MAP06_05 Task file SHA-256은 `d80cf04261811777b65b6c99ca8b7ae368fc39f4a895d024c6639ada5226c587`다.
- 새 MAP06_06 Task payload SHA-256은 `8c8dd6a780b334edf7fb8c1276c1cc5d64332bf26f8c5ab9b69e9dabcb22a542`다.
- MAP06_05는 COMPLETE 자격을 갖췄고 MAP06_06은 아직 `LOCKED / DO NOT START`였다.
- 205개 상태 행에서 MAP06_05까지 `COMPLETE`, MAP06_06 `CURRENT`, MAP06_07 이후는 `LOCKED`다.
- 새 Master/Status는 `73 COMPLETE / MAP06_06 CURRENT / 131 LOCKED`다.
- access assignments/clues/perceptible `12/12/12`, access canonical digest `5268b7ed2342f197fb5717c85dbfdb8e51b3c520c217ecf93ad14dc944ecf74f`를 입력 기준으로 보존한다.
- attachment boundary는 base-closed `12`, mandatory base-open `0`을 유지한다.
- Type4는 U+D mandatory, L/R independent이며 `UD`, `LUD`, `RUD`, `LRUD` 네 조합 모두 legal이다.
- current Assets meta baseline은 `3283`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
