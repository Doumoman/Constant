...
```yaml
patch_id: MAP03_11_MAP03_BATCH_AND_EXIT_TESTS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_10_CREATE_SITE_RESERVATION_OVERLAY_RESULT.md
  exact_status: PASS
  sha256: 70841399bd207f5ebb938ccc8b0f53767daf767f10df2cc387652b4b846ced77
requires_project_baseline:
  ...
  targeted_editmode: 3745/3745
  full_editmode: 3813/3813
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3070
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_11_MAP03_BATCH_AND_EXIT_TESTS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_11_MAP03_BATCH_AND_EXIT_TESTS.md
    destination: MapDesign/MCP/TASKS/MAP03_11_MAP03_BATCH_AND_EXIT_TESTS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~10은 `COMPLETE`, MAP03_11 이후는 `LOCKED`다.
- MAP03_10 Result는 exact `STATUS: PASS`이고 SHA-256은 `70841399bd207f5ebb938ccc8b0f53767daf767f10df2cc387652b4b846ced77`다.
- MAP03_10 runtime/editor/combined focused `133/133 / 28/28 / 161/161`, MAP03_01~09 aggregate `2098/2098`, MAP02 phase `667/667`, targeted `3745/3745`, full EditMode `3813/3813`, visual `18/18`, compile/Console error·warning 0이다.
...
- current Assets meta baseline은 `3070`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_10 COMPLETE와 MAP03_11 exact next를 기록한다.
- 새 status는 `45 COMPLETE / MAP03_11 CURRENT / 159 LOCKED`다.
