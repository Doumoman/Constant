...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_07
실제 다음: MAP05_08_BUILD_MANDATORY_ROUTE_GRAPH
...
MAP05_08 패치: PACKAGED v1.0 / RESULT 대기 (mandatory route graph와 generated edge CSV 기록)
Auto Start: NO
```
...
| MAP05 | 11 | 7 COMPLETE / 1 CURRENT — MAP05_08 / 3 LOCKED |
| MAP06 | 10 | LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **64 COMPLETE / 1 CURRENT / 140 LOCKED** |
...
- [ ] `MAP05_08_BUILD_MANDATORY_ROUTE_GRAPH` — Type1/2/3과 Type4(U+D 필수·L/R 선택) mask family 및 edge를 graph/CSV/SectorCell에 기록한다.
- [ ] `MAP05_09_IMPLEMENT_MANDATORY_ROUTE_VALIDATOR` — Type1/2/3/4 규칙(Type4 U/D 필수·L/R 선택), pair 대칭, terminal BFS, 독립 방문 후보를 검증한다.
...
```text
NEXT  : MAP05_08_BUILD_MANDATORY_ROUTE_GRAPH v1.0
THEN  : MAP05_09_IMPLEMENT_MANDATORY_ROUTE_VALIDATOR (separate patch only after MAP05_08 PASS/finalize)
LOCKED: MAP05_09 이후 전부
NO RUN: MAP05_07 및 이전 완료 Task 패키지
```

`MAP05_07_ADD_MANDATORY_ROUTE_LOOPS` Result는 STATUS `PASS`, SHA-256 `cbe4f9a136d488df134a6eee676e13950d5dfd15238abf3188a81ce532fbdf65`로 검수했다. accepted/independent loops `2/2`, actual `1654/1654`, compile/change conflict `0`, Assets meta `3215`를 승인했다. Type4는 U+D를 보장하고 L/R을 실제 graph adjacency로 보존한다. 다음 exact Task는 MAP05_08 하나다. MAP05_09는 MAP05_08 PASS/finalize 전까지 열지 않는다.
