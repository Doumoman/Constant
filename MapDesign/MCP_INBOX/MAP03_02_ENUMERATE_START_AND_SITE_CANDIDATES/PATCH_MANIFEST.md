...
```yaml
patch_id: MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1595/1595
  full_editmode: 1635/1635
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 2998
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES.md
    destination: MapDesign/MCP/TASKS/MAP03_02_ENUMERATE_START_AND_SITE_CANDIDATES.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01은 `COMPLETE`, MAP03_02 이후는 `LOCKED`다.
- MAP03_01 Result는 exact `STATUS: PASS`다.
- MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 1595/1595, full EditMode 1635/1635, compile/Console error·warning 0이다.
- immutable reservation ID/token/footprint/entry/Core seed/169-sector snapshot contracts와 Authoring CSV/meta 50/50, existing production/tests/asmdef는 보존됐다.
- current Assets meta baseline은 `2998`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_01 COMPLETE와 MAP03_02 exact next를 기록한다.
- 새 status는 `36 COMPLETE / MAP03_02 CURRENT / 168 LOCKED`다.
