...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_08
실제 다음: MAP06_09_IMPLEMENT_OPTIONAL_REGION_VALIDATOR
...
MAP06_09 패치: PACKAGED v1.0 / RESULT 대기 (optional region validation report)
Auto Start: NO
```
...
| MAP06 | 10 | 8 COMPLETE / 1 CURRENT — MAP06_09 / 1 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **76 COMPLETE / 1 CURRENT / 128 LOCKED** |
...
```text
NEXT  : MAP06_09_IMPLEMENT_OPTIONAL_REGION_VALIDATOR v1.0
THEN  : MAP06_10_MAP06_OVERLAY_AND_EXIT_TESTS (separate patch only after MAP06_09 PASS/finalize)
LOCKED: MAP06_10 이후 전부
NO RUN: MAP06_08 및 이전 완료 Task 패키지
```

`MAP06_08_ASSIGN_INACTIVE_BUFFERS` Result는 STATUS `PASS`, SHA-256 `43dd272802bfe6094ac5f1dff91ddb30229acf0c5a0885742509945a496bf58b`로 검수했다. source ReservedSite/Mandatory/Type0 `8/47/39`, approved Site-Mandatory overlap `{0,28,106}`, exclusive ReservedSite/MandatoryOnly/Type0 `8/44/39`, protected union `91`, inactive assignments `78`, DecorativeBoundary/InteriorInactive `52/26`, world-edge inactive `19`, protected-to-inactive/inactive-to-inactive edges `112/90`, canonical assignment digest `426f269e39d8a2d75a93020a00c7bb617612c00dd60a663fdbeffc60f8ea9578`를 승인했다. InactiveBufferAssignerTests `281/281`, OptionalReturn `289/289`, OptionalReward `279/279`, OptionalAccess `289/289`, Type0 `257/257`, MAP06 prior combined `630/630`, MAP05 aggregate `1959/1959`, actual total `3984/3984`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3304`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다. Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_09 하나다. MAP06_10은 MAP06_09 PASS/finalize 전까지 열지 않는다.
