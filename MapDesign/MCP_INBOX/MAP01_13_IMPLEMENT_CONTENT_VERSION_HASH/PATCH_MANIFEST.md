...
```yaml
patch_id: MAP01_13_IMPLEMENT_CONTENT_VERSION_HASH
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_12_IMPLEMENT_STATIC_DATA_REGISTRY_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 562/562
  full_editmode: 582/582
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_13_IMPLEMENT_CONTENT_VERSION_HASH.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_13_IMPLEMENT_CONTENT_VERSION_HASH.md
    destination: MapDesign/MCP/TASKS/MAP01_13_IMPLEMENT_CONTENT_VERSION_HASH.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~12는 `COMPLETE`, MAP01_13 이후는 `LOCKED`다.
- MAP01_12 Result는 exact `STATUS: PASS`, Registry 47 cases, targeted 562/562, full EditMode 582/582, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_12에서 보존됐다.
- 새 Master는 MAP01_12 COMPLETE, MAP01_13 exact next를 기록한다.
- 새 status는 `22 COMPLETE / MAP01_13 CURRENT / 182 LOCKED`다.
