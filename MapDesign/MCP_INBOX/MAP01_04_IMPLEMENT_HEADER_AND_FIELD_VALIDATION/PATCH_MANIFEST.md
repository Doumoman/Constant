...
```yaml
patch_id: MAP01_04_IMPLEMENT_HEADER_AND_FIELD_VALIDATION
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_03_IMPLEMENT_RFC4180_READER_RESULT.md
  exact_status: PASS
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_04_IMPLEMENT_HEADER_AND_FIELD_VALIDATION.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_04_IMPLEMENT_HEADER_AND_FIELD_VALIDATION.md
    destination: MapDesign/MCP/TASKS/MAP01_04_IMPLEMENT_HEADER_AND_FIELD_VALIDATION.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~03은 `COMPLETE`, MAP01_04 이후는 `LOCKED`다.
- MAP01_03 Result는 exact `STATUS: PASS`, reader 31/31, schema 23/23, importer 9/9, architecture 10/10, targeted 73/73, compile 0이다.
- Authoring CSV/meta 50/50과 MAP01_02 schema C#은 MAP01_03에서 보존됐다.
- 새 Master는 MAP01_03 COMPLETE, MAP01_04 exact next를 기록한다.
- 새 status는 `13 COMPLETE / MAP01_04 CURRENT / 191 LOCKED`다.
