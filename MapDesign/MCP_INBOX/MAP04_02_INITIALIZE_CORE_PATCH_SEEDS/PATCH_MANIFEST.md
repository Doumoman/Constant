...
```yaml
patch_id: MAP04_02_INITIALIZE_CORE_PATCH_SEEDS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_01_IMPLEMENT_BIOME_PATCH_MODELS_RESULT.md
  exact_status: PASS
  sha256: b7362725e0a4bdf952372b67ece63e1b0f3e26c4306845d09b5250753eedeb6d
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_02_INITIALIZE_CORE_PATCH_SEEDS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_02_INITIALIZE_CORE_PATCH_SEEDS.md
    destination: MapDesign/MCP/TASKS/MAP04_02_INITIALIZE_CORE_PATCH_SEEDS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~11, MAP04_01은 `COMPLETE`, MAP04_02 이후는 `LOCKED`다.
- MAP04_01 Result는 exact `STATUS: PASS`이고 SHA-256은 `b7362725e0a4bdf952372b67ece63e1b0f3e26c4306845d09b5250753eedeb6d`다.
- MAP04_01 focused `107/107`, required regressions `496/496`, actually executed `603/603`, compile/Console/relevant warning `0/0/0`을 통과했다.
- targeted/full은 사용자 지정 감축 profile에 따라 executed PASS가 아니라 discovery `3956/4025`로 분리 기록됐다.
- MAP04_01은 exact 7 Runtime + 1 test + 8 matching meta만 만들었고 existing/unexpected Assets modification은 `0/0`이다.
- current Assets meta baseline은 `3079`, Authoring CSV/meta `50/50`, accepted legacy Editor folder meta `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP04_01 COMPLETE와 MAP04_02 exact next를 기록한다.
- 새 status는 `47 COMPLETE / MAP04_02 CURRENT / 157 LOCKED`다.
