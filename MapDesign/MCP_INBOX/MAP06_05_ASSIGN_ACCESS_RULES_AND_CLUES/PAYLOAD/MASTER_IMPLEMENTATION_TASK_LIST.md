...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_04
실제 다음: MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES
...
MAP06_05 패치: PACKAGED v1.0 / RESULT 대기 (optional access rules and clues)
Auto Start: NO
```
...
| MAP06 | 10 | 4 COMPLETE / 1 CURRENT — MAP06_05 / 5 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **72 COMPLETE / 1 CURRENT / 132 LOCKED** |
...
```text
NEXT  : MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES v1.0
THEN  : MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER (separate patch only after MAP06_05 PASS/finalize)
LOCKED: MAP06_06 이후 전부
NO RUN: MAP06_04 및 이전 완료 Task 패키지
```

`MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS` Result는 STATUS `PASS`, SHA-256 `7cfb055bb6cb1df24206b25a1a5f046936c7fbdf58bd4b307d476ead4f28ed7a`로 검수했다. exact registered Type0 catalog `12`, catalog digest `a96d0c6860ea0ebf62ac9763efcb7a03fa61df932fde85b30cec76c4b0c50506`, regions/cells/assignments `12/39/39`, internal BaseEdges `30`, attachment base-closed `12`, mandatory base-open `0`, cross-region closed adjacency `13`, assignment digest `a26e73f25ff7267760a2507ec55b1acda3a6c39a8f3698fc37b190620ceca525`를 승인했다. Type0RouteMaskAssignerTests `257/257`, MAP06 prior combined `630/630`, MAP05 aggregate `1959/1959`, actual total `2846/2846`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3274`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다. mandatory graph `47/96/48/47`과 Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_05 하나다. MAP06_06은 MAP06_05 PASS/finalize 전까지 열지 않는다.
