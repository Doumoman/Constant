...
```yaml
patch_id: MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 2790/2790
  full_editmode: 2830/2830
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3036
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK.md
    destination: MapDesign/MCP/TASKS/MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~06은 `COMPLETE`, MAP03_07 이후는 `LOCKED`다.
- MAP03_06 Result는 exact `STATUS: PASS`다.
- MAP03_06 Result `NEXT`의 `MAP03_07_IMPLEMENT_CAPACITY_FLOOD_VALIDATION` 표기는 205개 backlog에 없는 non-authoritative 설명상 별칭이다. authoritative exact key는 기존 Master/Status의 `MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK`이며 이 이름 정정만으로 prior PASS나 Assets를 변경하지 않는다.
- MAP03_06 focused 248/248, MAP03_05 focused 270/270, MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 2790/2790, full EditMode 2830/2830, compile/Console error·warning 0이다.
- exact six groups/options/RNG draws/selected/final distance는 `6 / 3156 / 3156 / 6 / 15/15`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3036`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_06 COMPLETE와 MAP03_07 exact next를 기록한다.
- 새 status는 `41 COMPLETE / MAP03_07 CURRENT / 163 LOCKED`다.
