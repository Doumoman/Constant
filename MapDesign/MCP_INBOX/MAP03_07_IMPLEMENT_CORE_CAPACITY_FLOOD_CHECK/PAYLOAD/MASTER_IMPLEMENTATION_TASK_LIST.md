...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_06
실제 다음: MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK
...
MAP03_01~06 Result: PASS 검수 완료
MAP03_07 패치: PACKAGED v1.0 / RESULT 대기
Auto Start: NO
```
...
| MAP03 | 11 | 6 COMPLETE / 1 CURRENT / 4 LOCKED — MAP03_07 NEXT |
| MAP04 | 11 | LOCKED |
| MAP05 | 11 | LOCKED |
| MAP06 | 10 | LOCKED |
| MAP07 | 13 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **41 COMPLETE / 1 CURRENT / 163 LOCKED** |
...
```text
NEXT  : MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK v1.0
THEN  : MAP03_08_IMPLEMENT_VILLAGE_RESERVATION (separate patch only after MAP03_07 PASS)
LOCKED: MAP03_08 이후 전부
NO RUN: MAP03_06 및 이전 완료 Task 패키지
```

`MAP03_06_IMPLEMENT_RESERVATION_BACKTRACKING` Result는 exact `STATUS: PASS`로 검수했다. focused `248/248`, previous cost/distance/placement/candidate/model `270/270 / 239/239 / 170/170 / 268/268 / 81/81`, MAP02 phase `667/667`, starter options/draws `3156/3156`, selected placements `6`, final distance `15/15`, targeted `2790/2790`, full EditMode `2830/2830`, compile/Console `0/0`, Authoring CSV/meta `50/50`, final Assets meta `3036`, duplicate GUID `0`, exact Assets changes `18`, existing modification `0`을 승인했다. 다음 exact Task는 `MAP03_07_IMPLEMENT_CORE_CAPACITY_FLOOD_CHECK` 하나이며 별도 v1.0 패치로만 연다. MAP03_07 PASS와 별도 finalize 전에는 MAP03_08을 만들거나 실행하지 않는다.
