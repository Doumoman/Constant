...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_10, MAP07_01 ~ MAP07_13
실제 다음: MAP08_01_DEFINE_MOONPALACE_BIOME_PAIRS
...
MAP08 Phase: 0 COMPLETE / MAP08_01 CURRENT / 13 LOCKED
Auto Start: NO
```
...
| MAP08 | 14 | 0 COMPLETE / 1 CURRENT / 13 LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
| MAP11 | 14 | LOCKED |
| MAP12 | 14 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **91 COMPLETE / 1 CURRENT / 113 LOCKED** |
...
```text
NEXT  : MAP08_01_DEFINE_MOONPALACE_BIOME_PAIRS
THEN  : MAP08_02_IMPLEMENT_BOUNDARY_CANDIDATE_INDEX (locked until MAP08_01 PASS)
LOCKED: MAP08_02 이후 전부
NO RUN: MAP07_13 및 이전 완료 Task 패키지
```

`MAP07_13_MAP07_STARTER_AND_EXIT_TESTS` Result는 STATUS `PASS`, SHA-256 `263a2bbf291e4df25dbe6bc101986e11ebf39bc0fc3d0074759fb7450b6df77e`로 검수했다. MAP07 required total `5422/5422`, MAP06 required total `2746/2746`, MAP05 required total `1959/1959`, all required executions `10127/10127`, compile/Console/warning `0/0/0`, Assets meta `3409`, Authoring CSV/meta `50/50`, generated CSV `0`, Scene/Prefab/asmdef/ProjectSettings changes `0/0/0/0`이다. MAP07 Phase는 COMPLETE / EXIT APPROVED다.

`MAP08_01_DEFINE_MOONPALACE_BIOME_PAIRS`는 이 패치에서 CURRENT로 열린다. 이 Task의 범위는 월궁 biome 4종의 canonical pair contract와 H/V 방향 가능성, mandatory boundary precondition, `tool_requirement=NONE`, warning marker minimum을 정의하고 검증하는 것이다. `MAP08_02_IMPLEMENT_BOUNDARY_CANDIDATE_INDEX`와 이후는 별도 PASS Result 전까지 열지 않는다.
