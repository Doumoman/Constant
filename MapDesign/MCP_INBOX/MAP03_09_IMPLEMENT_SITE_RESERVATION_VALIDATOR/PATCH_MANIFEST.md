...
```yaml
patch_id: MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_08_IMPLEMENT_VILLAGE_RESERVATION_RESULT.md
  exact_status: PASS
  sha256: 19001c4445d4a362e24ceb64d75bd7e93105710b39576d8eb891b291c73b12ad
requires_project_baseline:
  ...
  targeted_editmode: 3344/3344
  full_editmode: 3384/3384
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3054
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR.md
    destination: MapDesign/MCP/TASKS/MAP03_09_IMPLEMENT_SITE_RESERVATION_VALIDATOR.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~08은 `COMPLETE`, MAP03_09 이후는 `LOCKED`다.
- MAP03_08 Result는 exact `STATUS: PASS`이고 SHA-256은 `19001c4445d4a362e24ceb64d75bd7e93105710b39576d8eb891b291c73b12ad`다.
- MAP03_08 focused 339/339, MAP03_07 focused 215/215, MAP03_06 focused 248/248, MAP03_05 focused 270/270, MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 3344/3344, full EditMode 3384/3384, compile/Console error·warning 0이다.
- exact candidates/source/entry-out/sites/witnesses/witness sectors/overlap/entry conflict/RNG는 `676 / 624 / 52 / 6+1 / 4 / 20 / 0 / 0 / 3156->3159`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3054`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_08 COMPLETE와 MAP03_09 exact next를 기록한다.
- 새 status는 `43 COMPLETE / MAP03_09 CURRENT / 161 LOCKED`다.
