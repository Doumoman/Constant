...
```yaml
patch_id: MAP01_15_REPAIR_STALE_INTERACTION_TAGS_TEST
patch_version: 1.4
requires_status:
  current_task: TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
  task_states:
    ...
    MAP01_15_CREATE_CSV_IMPORT_WINDOW: CURRENT
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_15_CREATE_CSV_IMPORT_WINDOW_RESULT.md
  exact_status: BLOCKED
requires_csv_import_report:
  path: MapDesign/MCP/REPORTS/CsvImportReport.json
    exact_sha256: a93a0a771fd9e5d1c07094ef6186d87717e7845f5762935fd4127e99237e13b3
  schema_version: 1
  published: true
  error_count: 0
  warning_count: 0
  current_version: 1
  candidate_content_hash: 1c41b14c2734200999e779ad1317c5bc2ef5208da1c3b4bc30347e47182cfeaf
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
    destination: MapDesign/MCP/TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
    mode: replace_if_sha256_matches
    required_existing_sha256: 39e57744ad199bcc69a375d856bf6e25cb0348a9749199312b32ca14277b5fbd
forbidden_operations:
  - delete
  - overwrite_any_task_except_exact_current_task_repair
...
- 적용 전/후 Current Task는 동일한 `TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md`다.
- exact 205개 상태는 `24 COMPLETE / MAP01_15 CURRENT / 180 LOCKED`이며 Master/Status는 변경하지 않는다.
- MAP01_15 Result는 exact `STATUS: BLOCKED`; report는 schema v1, 25 ERROR, 0 WARNING, unpublished/version 0/hash null이다.
- 기존 v1.3 Task 파일 SHA-256이 manifest 값과 일치할 때만 v1.4 payload로 교체한다. 다르면 `BLOCKED`다.
- PATCH APPLY 단계에서는 Assets, CSV/meta, C#, test, asmdef, Master, Status, Result를 변경하지 않는다.
- 실행 단계에서도 authoritative dictionary와 fixed 50 CSV/meta는 읽기 전용이다.
- MAP01_16은 계속 `LOCKED`이며 자동 시작하지 않는다.
