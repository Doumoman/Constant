...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_06
실제 다음: MAP06_07_IMPLEMENT_RETURN_POLICY
...
MAP06_07 패치: PACKAGED v1.0 / RESULT 대기 (optional return policy)
Auto Start: NO
```
...
| MAP06 | 10 | 6 COMPLETE / 1 CURRENT — MAP06_07 / 3 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **74 COMPLETE / 1 CURRENT / 130 LOCKED** |
...
```text
NEXT  : MAP06_07_IMPLEMENT_RETURN_POLICY v1.0
THEN  : MAP06_08_ASSIGN_INACTIVE_BUFFERS (separate patch only after MAP06_07 PASS/finalize)
LOCKED: MAP06_08 이후 전부
NO RUN: MAP06_06 및 이전 완료 Task 패키지
```

`MAP06_06_CALCULATE_OPTIONAL_REWARD_TIER` Result는 STATUS `PASS`, SHA-256 `0acfcd73b6485e99a56dd4d44bff50f871548e266ed003607466961632ec449c`로 검수했다. source regions/Type0 cells/access/reward assignments `12/39/12/12`, tier Low/Medium/High/Unique `5/1/2/4`, contribution depth/tool/fuel/hidden `62/9/7/5`, score min/max `2/12`, preview `2`, mandatory reward selection `0`, reward-tier canonical digest `c3430c42a27937e143fa89c5839282b9533b62d5fb74fb26fdad490cb545958e`를 승인했다. OptionalRewardTierCalculatorTests `279/279`, OptionalAccess `289/289`, Type0 `257/257`, MAP06 prior combined `630/630`, MAP05 aggregate `1959/1959`, actual total `3414/3414`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3290`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다. attachment base-closed `12`, mandatory base-open `0`, Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_07 하나다. MAP06_08은 MAP06_07 PASS/finalize 전까지 열지 않는다.
