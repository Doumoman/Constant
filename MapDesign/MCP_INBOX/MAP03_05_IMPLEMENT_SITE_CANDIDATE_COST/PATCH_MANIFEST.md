...
```yaml
patch_id: MAP03_05_IMPLEMENT_SITE_CANDIDATE_COST
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP03_04_IMPLEMENT_SITE_DISTANCE_INDEX_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 2272/2272
  full_editmode: 2312/2312
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 3020
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_05_IMPLEMENT_SITE_CANDIDATE_COST.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_05_IMPLEMENT_SITE_CANDIDATE_COST.md
    destination: MapDesign/MCP/TASKS/MAP03_05_IMPLEMENT_SITE_CANDIDATE_COST.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08, MAP03_01~04는 `COMPLETE`, MAP03_05 이후는 `LOCKED`다.
- MAP03_04 Result는 exact `STATUS: PASS`다.
- MAP03_04 focused 239/239, MAP03_03 focused 170/170, MAP03_02 focused 268/268, MAP03_01 focused 81/81, MAP02 phase 667/667, targeted 2272/2272, full EditMode 2312/2312, compile/Console error·warning 0이다.
- exhaustive sector pairs `28561`, exact distance policy `6 keys / 15 records / 15 constraints`, Authoring CSV/meta 50/50, existing production/tests/asmdef가 보존됐다.
- current Assets meta baseline은 `3020`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP03_04 COMPLETE와 MAP03_05 exact next를 기록한다.
- 새 status는 `39 COMPLETE / MAP03_05 CURRENT / 165 LOCKED`다.
