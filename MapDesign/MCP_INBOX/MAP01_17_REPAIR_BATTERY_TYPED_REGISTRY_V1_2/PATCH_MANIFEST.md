...
```yaml
patch_id: MAP01_17_REPAIR_BATTERY_TYPED_REGISTRY_V1_2
patch_version: 1.2
requires_status:
  current_task: TASKS/MAP01_17_MAP01_EXIT_AUDIT.md
  task_states:
    ...
    MAP01_17_MAP01_EXIT_AUDIT: CURRENT
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_17_MAP01_EXIT_AUDIT_RESULT.md
  exact_status: BLOCKED
requires_files:
  - MapDesign/MCP/TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_1.md
  - MapDesign/MCP_INBOX/MAP01_17_REPAIR_BATTERY_TYPED_REGISTRY/.APPLIED
requires_project_baseline:
  ...
  targeted_editmode: 801/801
  full_editmode: 821/821
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_17_MAP01_EXIT_AUDIT.md
supplements_current_task: TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_2.md
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_2.md
    destination: MapDesign/MCP/TASKS/MAP01_17_MAP01_EXIT_AUDIT_REMEDIATION_V1_2.md
    mode: create
...
- 적용 전/후 Current Task는 `TASKS/MAP01_17_MAP01_EXIT_AUDIT.md`다.
- exact state는 `26 COMPLETE / MAP01_17 CURRENT / 178 LOCKED`이며 Master/Status/current Task는 변경하지 않는다.
- MAP01_17 Result는 exact `STATUS: BLOCKED`, audit `34 PASS / 6 FAIL`; v1.1 addendum apply는 PASS했지만 implementation preflight가 fixture consumer allowlist 누락으로 중단됐다.
- production import는 exact 50 SUCCESS, ERROR/WARNING/FK 0, published/hash stable이고 Battery source PK는 `5/5`다.
- 기존 v1.1 addendum가 존재해야 하며 patch apply는 v1.2 remediation addendum 하나만 create하고 Assets/C#/tests/CSV/meta/Result를 변경하지 않는다.
- MAP02_01 이후는 계속 LOCKED이며 자동 시작하지 않는다.
