...
```yaml
patch_id: MAP01_15_REPAIR_AUTHORITATIVE_SCHEMA_CONTRACTS
patch_version: 1.1
requires_status:
...
copy_operations:
  - source: PAYLOAD/TASKS/MAP01_15_CREATE_CSV_IMPORT_WINDOW.md
    ...
    required_existing_sha256: 7f0982e749004533cb78f3bd535e2ba7a7836ff9ad41d1f13a0143c3524cff5f
...
- 기존 Task 파일 SHA-256이 manifest 값과 일치할 때만 v1.1 payload로 교체한다. 다르면 `BLOCKED`다.
