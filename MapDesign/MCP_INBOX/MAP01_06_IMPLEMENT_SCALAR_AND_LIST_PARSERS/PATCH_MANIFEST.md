...
```yaml
patch_id: MAP01_06_IMPLEMENT_SCALAR_AND_LIST_PARSERS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_05_IMPLEMENT_PRIMARY_KEY_INDEX_RESULT.md
  exact_status: PASS
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_06_IMPLEMENT_SCALAR_AND_LIST_PARSERS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_06_IMPLEMENT_SCALAR_AND_LIST_PARSERS.md
    destination: MapDesign/MCP/TASKS/MAP01_06_IMPLEMENT_SCALAR_AND_LIST_PARSERS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~05는 `COMPLETE`, MAP01_06 이후는 `LOCKED`다.
- MAP01_05 Result는 exact `STATUS: PASS`, PK 32/32, validator 29/29, reader 31/31, schema 23/23, importer 9/9, architecture 10/10, targeted 134/134, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 MAP01_02/03/04 production C#은 MAP01_05에서 보존됐다.
- 새 Master는 MAP01_05 COMPLETE, MAP01_06 exact next를 기록한다.
- 새 status는 `15 COMPLETE / MAP01_06 CURRENT / 189 LOCKED`다.
