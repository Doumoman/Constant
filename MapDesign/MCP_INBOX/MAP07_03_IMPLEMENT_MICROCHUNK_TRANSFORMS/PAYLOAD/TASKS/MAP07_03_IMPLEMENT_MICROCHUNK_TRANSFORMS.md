...
Do not modify MAP07_01 model files or MAP07_02 tile-layer rule files unless a compile-only signature issue makes it unavoidable. If unavoidable, stop and report `BLOCKED` unless the change is strictly mechanical and already permitted by this Task's write allowlist.
