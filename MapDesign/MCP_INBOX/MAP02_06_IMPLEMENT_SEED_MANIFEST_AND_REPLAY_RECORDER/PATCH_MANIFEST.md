...
```yaml
patch_id: MAP02_06_IMPLEMENT_SEED_MANIFEST_AND_REPLAY_RECORDER
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP02_05_IMPLEMENT_PASS_EXECUTION_RECORDS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1277/1277
  full_editmode: 1297/1297
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 2973
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP02_06_IMPLEMENT_SEED_MANIFEST_AND_REPLAY_RECORDER.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP02_06_IMPLEMENT_SEED_MANIFEST_AND_REPLAY_RECORDER.md
    destination: MapDesign/MCP/TASKS/MAP02_06_IMPLEMENT_SEED_MANIFEST_AND_REPLAY_RECORDER.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~05는 `COMPLETE`, MAP02_06 이후는 `LOCKED`다.
- MAP02_05 Result는 exact `STATUS: PASS`, focused 77/77, targeted 1277/1277, full EditMode 1297/1297, compile/Console error·warning 0이다.
- immutable execution records/clock/retry cause contracts와 기존 `56/103/90/84` regressions, Authoring CSV/meta 50/50, existing production/tests/asmdef는 보존됐다.
- current Assets meta baseline은 `2973`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP02_05 COMPLETE, MAP02_06 exact next를 기록한다.
- 새 status는 `32 COMPLETE / MAP02_06 CURRENT / 172 LOCKED`다.
