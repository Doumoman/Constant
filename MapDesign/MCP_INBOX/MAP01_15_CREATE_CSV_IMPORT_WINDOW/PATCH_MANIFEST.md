...
```yaml
patch_id: MAP01_15_CREATE_CSV_IMPORT_WINDOW
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_14_IMPLEMENT_ATOMIC_PUBLISH_AND_IMPORT_REPORT_RESULT.md
  exact_status: PASS
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~14는 `COMPLETE`, MAP01_15 이후는 `LOCKED`다.
- MAP01_14 Result는 exact `STATUS: PASS`, atomic/report 55/55, targeted 671/671, full EditMode 691/691, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_14에서 보존됐다.
- 새 Master는 MAP01_14 COMPLETE, MAP01_15 exact next를 기록한다.
- 새 status는 `24 COMPLETE / MAP01_15 CURRENT / 180 LOCKED`다.
