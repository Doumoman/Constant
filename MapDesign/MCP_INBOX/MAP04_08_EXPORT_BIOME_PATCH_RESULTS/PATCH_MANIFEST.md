...
```yaml
patch_id: MAP04_08_EXPORT_BIOME_PATCH_RESULTS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP04_07_IMPLEMENT_PATCH_CLEANUP_RESULT.md
  exact_status: PASS
  sha256: 7fbef41a6b6f054e2a8c6270a9cec6d3825143d0291c7c6bf5952e57f46a51dd
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP04_08_EXPORT_BIOME_PATCH_RESULTS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP04_08_EXPORT_BIOME_PATCH_RESULTS.md
    destination: MapDesign/MCP/TASKS/MAP04_08_EXPORT_BIOME_PATCH_RESULTS.md
    mode: create
...
- 205개 상태 행에서 MAP04_01~07까지 `COMPLETE`, MAP04_08 이후는 `LOCKED`다.
- MAP04_07 Result는 exact `PASS`, SHA-256 `7fbef41a6b6f054e2a8c6270a9cec6d3825143d0291c7c6bf5952e57f46a51dd`다.
- MAP04_07 actual `390/390`, output `17/165/4`, score `0/0/100`, RNG `1912->1912`, integrity/compile/change conflict `0`이다.
- current Assets meta `3125`, Authoring CSV/meta `50/50`, duplicate GUID `0`이다.
- 새 Master/Status는 `53 COMPLETE / MAP04_08 CURRENT / 151 LOCKED`다.
