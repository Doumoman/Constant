...
```yaml
patch_id: MAP06_01_REPAIR_OPTIONAL_REGION_PHASE_BOUNDARY_ASSERTIONS
patch_version: 1.1
revision_note: MAP06_01 FAIL 후 optional region model 구현은 보존하고 기존 MAP05 phase-boundary tests 6개만 MAP06_01 완료 경계에 맞게 교정한다. MAP06_02는 시작하지 않는다.
requires_status:
...
requires_result:
  ...
  exact_status: FAIL
  sha256: 254092c80abdec87d20c9276854539ca7225e33738dfbe2419384a48710fb553
repair_basis:
  current_task_sha256: 79b806802dab4a86f3cdc0b6193be4c8f5c97a2e6a9cc8bcc023259752b49a62
  failed_result_sha256: 254092c80abdec87d20c9276854539ca7225e33738dfbe2419384a48710fb553
  optional_region_models_tests: 194/194 PASS
  existing_map05_aggregate_observed: 1953/1959 PASS
  actual_total_observed: 2147/2153 PASS
  failed_existing_phase_boundary_tests: 6
  created_runtime_models: 6
  created_editmode_tests: 1
  assets_meta_total: 3254
...
copy_operations:
  - source: PAYLOAD/TASKS/MAP06_01_IMPLEMENT_OPTIONAL_REGION_MODELS.md
    ...
    required_existing_sha256: 79b806802dab4a86f3cdc0b6193be4c8f5c97a2e6a9cc8bcc023259752b49a62
...
- 현재 Task SHA-256은 `79b806802dab4a86f3cdc0b6193be4c8f5c97a2e6a9cc8bcc023259752b49a62`다.
- 현재 MAP06_01 Result는 exact `FAIL`, SHA-256 `254092c80abdec87d20c9276854539ca7225e33738dfbe2419384a48710fb553`다.
- 신규 OptionalRegionModelsTests `194/194`는 PASS했고, 실패 원인은 MAP05-era phase-boundary assertions 6개다.
