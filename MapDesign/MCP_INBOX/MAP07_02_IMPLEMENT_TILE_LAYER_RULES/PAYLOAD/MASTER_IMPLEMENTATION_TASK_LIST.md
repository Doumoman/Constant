...
실제 다음: MAP07_02_IMPLEMENT_TILE_LAYER_RULES
...
MAP07_02 패치: PACKAGED v1.0 / RESULT 대기 (tile layer rules)
Auto Start: NO
```
...
| MAP07 | 13 | 1 COMPLETE / 1 CURRENT / 11 LOCKED — MAP07_02 |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
| MAP11 | 14 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **79 COMPLETE / 1 CURRENT / 125 LOCKED** |
...
```text
NEXT  : MAP07_02_IMPLEMENT_TILE_LAYER_RULES v1.0
THEN  : MAP07_03_IMPLEMENT_MICROCHUNK_TRANSFORMS (separate patch only after MAP07_02 PASS/finalize)
LOCKED: MAP07_03 이후 전부
NO RUN: MAP06_09 및 이전 완료 Task 패키지
```

`MAP07_01_IMPLEMENT_MICROCHUNK_DEFINITION` Result는 STATUS `PASS`, SHA-256 `b11e740b808effe5a528a68497527edd0ab92fcc8c1a823dd6baa0d39363f474`로 검수했다. Microchunk definition model digest `673f8a5057a28e6b2dbceac1a43f4eee4b30f0ec2a3738939107759e229cb7d5`, acceptance `4851/4851`, compile/Console/warning `0/0/0`, Assets meta `3334`, Authoring CSV/meta `50/50`, generated CSV `0`, Scene/Prefab/asmdef/ProjectSettings changes `0/0/0/0`이다. 다음 exact Task는 MAP07_02 하나다. MAP07_03은 MAP07_02 PASS/finalize 전까지 열지 않는다.
