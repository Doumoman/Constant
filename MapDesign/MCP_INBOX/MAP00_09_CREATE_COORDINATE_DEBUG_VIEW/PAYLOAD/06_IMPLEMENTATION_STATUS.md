...
```text
TASKS/MAP00_09_CREATE_COORDINATE_DEBUG_VIEW.md
```
...
| MAP00_09_CREATE_COORDINATE_DEBUG_VIEW | CURRENT |
...
현재는 `MAP00_09_CREATE_COORDINATE_DEBUG_VIEW` 하나만 수행한다. Runtime 수정, MAP00 exit audit, CSV, 생성 알고리즘은 선행 구현하지 않는다.

MAP00_09가 PASS해도 MAP00_10을 자동 시작하지 않는다. STATUS FINALIZE는 MAP00_09를 COMPLETE로 바꾸고 Current Task를 NONE으로 만든 뒤 종료한다.
