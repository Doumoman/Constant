...
```yaml
patch_id: MAP01_08_IMPLEMENT_BIOME_BOUNDARY_DEFINITIONS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_07_IMPLEMENT_WORLD_ROUTE_DEFINITIONS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 290/290
  full_editmode: 333/333
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_08_IMPLEMENT_BIOME_BOUNDARY_DEFINITIONS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_08_IMPLEMENT_BIOME_BOUNDARY_DEFINITIONS.md
    destination: MapDesign/MCP/TASKS/MAP01_08_IMPLEMENT_BIOME_BOUNDARY_DEFINITIONS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~07은 `COMPLETE`, MAP01_08 이후는 `LOCKED`다.
- MAP01_07 Result는 exact `STATUS: PASS`, definitions 59/59, parser 97/97, PK 32/32, validator 29/29, reader 31/31, schema 23/23, importer 9/9, architecture 10/10, targeted 290/290, full EditMode 333/333, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 MAP01_02~06 production C#은 MAP01_07에서 보존됐다.
- 새 Master는 MAP01_07 COMPLETE, MAP01_08 exact next를 기록한다.
- 새 status는 `17 COMPLETE / MAP01_08 CURRENT / 187 LOCKED`다.
