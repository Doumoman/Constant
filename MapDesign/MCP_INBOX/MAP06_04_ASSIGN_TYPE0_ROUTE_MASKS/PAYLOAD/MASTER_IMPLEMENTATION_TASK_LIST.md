...
```text
완료: MAP00_01 ~ MAP00_10, MAP01_01 ~ MAP01_17, MAP02_01 ~ MAP02_08, MAP03_01 ~ MAP03_11, MAP04_01 ~ MAP04_11, MAP05_01 ~ MAP05_11, MAP06_01 ~ MAP06_03
실제 다음: MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS
...
MAP06_04 패치: PACKAGED v1.0 / RESULT 대기 (registered Type0 route mask assignment)
Auto Start: NO
```
...
| MAP06 | 10 | 3 COMPLETE / 1 CURRENT — MAP06_04 / 6 LOCKED |
| MAP07 | 13 | LOCKED |
| MAP08 | 14 | LOCKED |
| MAP09 | 13 | LOCKED |
| MAP10 | 12 | LOCKED |
...
| MAP14 | 13 | LOCKED |
| MAP15 | 18 | LOCKED |
| **합계** | **205** | **70 COMPLETE / 1 CURRENT / 134 LOCKED** |
...
```text
NEXT  : MAP06_04_ASSIGN_TYPE0_ROUTE_MASKS v1.0
THEN  : MAP06_05_ASSIGN_ACCESS_RULES_AND_CLUES (separate patch only after MAP06_04 PASS/finalize)
LOCKED: MAP06_05 이후 전부
NO RUN: MAP06_03 및 이전 완료 Task 패키지
```

`MAP06_03_IMPLEMENT_OPTIONAL_REGION_GROWER` Result는 STATUS `PASS`, SHA-256 `370a15f504d46492a591d064ee70dbc35d27b5b55ab4b621617aedae95d489b0`로 검수했다. fixture는 source/attempted/accepted/rejected/limit-skipped `51/32/12/20/19`, accepted cells `39`, depth buckets `5/0/2/5`, canonical digest `1f00f718bdb8d79fbf88923be0d81e0075987267c024cc624086ee6194998caa`이며 exact-one bridge `12/12`, same-region L+R through `0`, overlap `0`이다. OptionalRegionGrowerTests `234/234`, attachment `202/202`, models `194/194`, 기존 MAP05 aggregate `1959/1959`, actual total `2589/2589`, failed/skipped `0/0`, compile/Console/warning `0/0/0`, Assets meta `3266`, Authoring CSV/meta `50/50`, duplicate GUID `0`을 승인했다. mandatory graph `47/96/48/47`과 Type4 U+D mandatory/L/R independent, UD/LUD/RUD/LRUD legal 규칙은 보존됐다. 다음 exact Task는 MAP06_04 하나다. MAP06_05는 MAP06_04 PASS/finalize 전까지 열지 않는다.
