...
```yaml
patch_id: MAP01_10_IMPLEMENT_MICROCHUNK_POPULATION_ITEM_DEFINITIONS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP01_09_IMPLEMENT_SPECIAL_VILLAGE_DEFINITIONS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 374/374
  full_editmode: 417/417
  compile_errors: 0
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP01_10_IMPLEMENT_MICROCHUNK_POPULATION_ITEM_DEFINITIONS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP01_10_IMPLEMENT_MICROCHUNK_POPULATION_ITEM_DEFINITIONS.md
    destination: MapDesign/MCP/TASKS/MAP01_10_IMPLEMENT_MICROCHUNK_POPULATION_ITEM_DEFINITIONS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10과 MAP01_01~09는 `COMPLETE`, MAP01_10 이후는 `LOCKED`다.
- MAP01_09 Result는 exact `STATUS: PASS`, definitions 48/48, targeted 374/374, full EditMode 417/417, compile/warning 0/0이다.
- Authoring CSV/meta 50/50과 기존 production C#은 MAP01_09에서 보존됐다.
- 새 Master는 MAP01_09 COMPLETE, MAP01_10 exact next를 기록한다.
- 새 status는 `19 COMPLETE / MAP01_10 CURRENT / 185 LOCKED`다.
