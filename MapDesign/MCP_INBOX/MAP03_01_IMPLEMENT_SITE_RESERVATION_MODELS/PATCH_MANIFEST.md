...
```yaml
patch_id: MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS
patch_version: 1.0
requires_status:
  current_task: NONE
  task_states:
...
requires_result:
  path: MapDesign/MCP/REPORTS/MAP02_08_MAP02_EXIT_TESTS_RESULT.md
  exact_status: PASS
requires_project_baseline:
  ...
  targeted_editmode: 1514/1514
  full_editmode: 1554/1554
  compile_errors: 0
  relevant_new_warnings: 0
  authoring_csv_total: 50
  csv_meta_total: 50
  assets_meta_total: 2989
...
forbids_started_task_prefixes:
  ...
  - MAP14
  - MAP15
sets_current_task: TASKS/MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS.md
    destination: MapDesign/MCP/TASKS/MAP03_01_IMPLEMENT_SITE_RESERVATION_MODELS.md
    mode: create
...
- 205개 상태 행에서 MAP00_01~10, MAP01_01~17, MAP02_01~08은 `COMPLETE`, MAP03_01 이후는 `LOCKED`다.
- MAP02_08 Result는 exact `STATUS: PASS`, `MAP02 EXIT: APPROVED`, `MAP03 ENTRY: ELIGIBLE FOR SEPARATE PATCH`다.
- MAP02_08 신규 72/72, phase focused 667/667, targeted 1514/1514, full EditMode 1554/1554, visual 12/12, compile/Console error·warning 0이다.
- exact topology/RNG/root/manifest/replay/static hash contracts와 Authoring CSV/meta 50/50, existing production/tests/asmdef는 보존됐다.
- current Assets meta baseline은 `2989`, accepted legacy Editor folder meta는 `6/6`, duplicate GUID group은 `0`이다.
- 새 Master는 MAP02 Phase COMPLETE/EXIT APPROVED와 MAP03_01 exact next를 기록한다.
- 새 status는 `35 COMPLETE / MAP03_01 CURRENT / 169 LOCKED`다.
