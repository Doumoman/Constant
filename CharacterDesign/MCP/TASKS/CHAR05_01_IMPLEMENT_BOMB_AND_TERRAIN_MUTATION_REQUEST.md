# CHAR05_01 — 폭탄·퓨즈·폭발 피해·MAP 지형 변경 요청 구현

TASK ID: CHAR05_01  
PHASE: CHAR05  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR04_04

## 목표

폭탄·로프·체력·위험 지형·사망·런 상태·HUD·프레젠테이션을 연결한다.

현재 작업 범위는 **폭탄·퓨즈·폭발 피해·MAP 지형 변경 요청 구현**에 한정한다.
...
- `CharacterDesign/MCP/RESULTS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘폭탄·퓨즈·폭발 피해·MAP 지형 변경 요청 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST_RESULT.md`
...
권장 제목: `CHAR05_01: 폭탄·퓨즈·폭발 피해·MAP 지형 변경 요청 구현`
