...
- `CharacterDesign/MCP/TASKS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘투척·환경 충격 계약과 일반 공격 부재 검증’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK_RESULT.md`
...
권장 제목: `CHAR04_03: 투척·환경 충격 계약과 일반 공격 부재 검증`
