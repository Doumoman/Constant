# CHAR01_03 — 점프·가변 높이·코요테·공중 제어·낙하·착지 구현

TASK ID: CHAR01_03  
PHASE: CHAR01  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR01_02

## 목표

입력·상태·충돌·지상 모터·점프를 하나의 플레이어 이동 코어로 구현한다.

현재 작업 범위는 **점프·가변 높이·코요테·공중 제어·낙하·착지 구현**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘점프·가변 높이·코요테·공중 제어·낙하·착지 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING_RESULT.md`
...
권장 제목: `CHAR01_03: 점프·가변 높이·코요테·공중 제어·낙하·착지 구현`
