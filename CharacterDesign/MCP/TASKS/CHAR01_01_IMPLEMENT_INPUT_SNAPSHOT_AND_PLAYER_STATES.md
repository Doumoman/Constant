# CHAR01_01 — 논리 입력 스냅샷·버퍼와 플레이어 상태 머신 구현

TASK ID: CHAR01_01  
PHASE: CHAR01  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR00_03

## 목표

입력·상태·충돌·지상 모터·점프를 하나의 플레이어 이동 코어로 구현한다.

현재 작업 범위는 **논리 입력 스냅샷·버퍼와 플레이어 상태 머신 구현**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR01_01_IMPLEMENT_INPUT_SNAPSHOT_AND_PLAYER_STATES.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR01_01_IMPLEMENT_INPUT_SNAPSHOT_AND_PLAYER_STATES_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘논리 입력 스냅샷·버퍼와 플레이어 상태 머신 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR01_01_IMPLEMENT_INPUT_SNAPSHOT_AND_PLAYER_STATES_RESULT.md`
...
권장 제목: `CHAR01_01: 논리 입력 스냅샷·버퍼와 플레이어 상태 머신 구현`
