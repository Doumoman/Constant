# CHAR06_01 — 생성 맵 플레이어 생성·Type1/2/3 필수·Type0 선택 경로 검증

TASK ID: CHAR06_01  
PHASE: CHAR06  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR05_05

## 목표

실제 생성 맵에서 필수·선택 경로와 전체 런을 확인하고 최종 컴파일·빌드·문서 게이트를 통과시킨다.

현재 작업 범위는 **생성 맵 플레이어 생성·Type1/2/3 필수·Type0 선택 경로 검증**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘생성 맵 플레이어 생성·Type1/2/3 필수·Type0 선택 경로 검증’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES_RESULT.md`
...
권장 제목: `CHAR06_01: 생성 맵 플레이어 생성·Type1/2/3 필수·Type0 선택 경로 검증`
