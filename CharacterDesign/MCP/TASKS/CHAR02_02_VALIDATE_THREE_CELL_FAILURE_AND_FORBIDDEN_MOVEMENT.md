# CHAR02_02 — 3셀 기본 통과 실패와 벽 점프·대시·이중 점프 부재 검증

TASK ID: CHAR02_02  
PHASE: CHAR02  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR02_01

## 목표

기획된 셀 이동 문법과 금지된 이동 능력을 실제 수치와 테스트로 확정한다.

현재 작업 범위는 **3셀 기본 통과 실패와 벽 점프·대시·이중 점프 부재 검증**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR02_02_VALIDATE_THREE_CELL_FAILURE_AND_FORBIDDEN_MOVEMENT.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR02_02_VALIDATE_THREE_CELL_FAILURE_AND_FORBIDDEN_MOVEMENT_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘3셀 기본 통과 실패와 벽 점프·대시·이중 점프 부재 검증’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR02_02_VALIDATE_THREE_CELL_FAILURE_AND_FORBIDDEN_MOVEMENT_RESULT.md`
...
권장 제목: `CHAR02_02: 3셀 기본 통과 실패와 벽 점프·대시·이중 점프 부재 검증`
