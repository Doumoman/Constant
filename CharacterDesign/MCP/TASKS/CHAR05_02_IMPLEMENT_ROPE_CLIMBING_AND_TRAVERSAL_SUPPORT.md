...
- `CharacterDesign/MCP/TASKS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘로프·등반·방 경계 제한과 보조 이동 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT_RESULT.md`
...
권장 제목: `CHAR05_02: 로프·등반·방 경계 제한과 보조 이동 구현`
