...
- `CharacterDesign/MCP/TASKS/CHAR04_02_IMPLEMENT_STOMP_STUN_REMOVAL_AND_CONTACT_DAMAGE.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR04_02_IMPLEMENT_STOMP_STUN_REMOVAL_AND_CONTACT_DAMAGE_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘밟기·반동·첫 기절·두 번째 제거·측면 피격 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR04_02_IMPLEMENT_STOMP_STUN_REMOVAL_AND_CONTACT_DAMAGE_RESULT.md`
...
권장 제목: `CHAR04_02: 밟기·반동·첫 기절·두 번째 제거·측면 피격 구현`
