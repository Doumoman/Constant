# CHAR04_01 — Carryable 검색·휴대·안전 내려놓기·방향 투척 구현

TASK ID: CHAR04_01  
PHASE: CHAR04  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR03_03

## 목표

들기·내려놓기·던지기와 밟기·기절·제거·피격을 하나의 상호작용 전투 코어로 구현한다.

현재 작업 범위는 **Carryable 검색·휴대·안전 내려놓기·방향 투척 구현**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘Carryable 검색·휴대·안전 내려놓기·방향 투척 구현’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW_RESULT.md`
...
권장 제목: `CHAR04_01: Carryable 검색·휴대·안전 내려놓기·방향 투척 구현`
