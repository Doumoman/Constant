# CHAR03_01 — MAP 좌표·월드 질의와 방 경계 준비 게이트 연결

TASK ID: CHAR03_01  
PHASE: CHAR03  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR02_03

## 목표

MAP 좌표·월드 질의·방 준비 게이트와 카메라룸 전환을 캐릭터에 연결한다.

현재 작업 범위는 **MAP 좌표·월드 질의와 방 경계 준비 게이트 연결**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR03_01_CONNECT_MAP_WORLD_QUERY_AND_BOUNDARY_GATE.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR03_01_CONNECT_MAP_WORLD_QUERY_AND_BOUNDARY_GATE_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘MAP 좌표·월드 질의와 방 경계 준비 게이트 연결’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR03_01_CONNECT_MAP_WORLD_QUERY_AND_BOUNDARY_GATE_RESULT.md`
...
권장 제목: `CHAR03_01: MAP 좌표·월드 질의와 방 경계 준비 게이트 연결`
