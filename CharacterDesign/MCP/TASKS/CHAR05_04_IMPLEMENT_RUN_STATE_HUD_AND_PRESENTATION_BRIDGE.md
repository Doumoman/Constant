# CHAR05_04 — 런 상태·인벤토리·HUD·애니메이션/사운드 이벤트 연결

TASK ID: CHAR05_04  
PHASE: CHAR05  
STATE SOURCE: `CharacterDesign/MCP/06_IMPLEMENTATION_STATUS.md`  
DEPENDS ON: CHAR05_03

## 목표

폭탄·로프·체력·위험 지형·사망·런 상태·HUD·프레젠테이션을 연결한다.

현재 작업 범위는 **런 상태·인벤토리·HUD·애니메이션/사운드 이벤트 연결**에 한정한다.
...
- `CharacterDesign/MCP/TASKS/CHAR05_04_IMPLEMENT_RUN_STATE_HUD_AND_PRESENTATION_BRIDGE.md`
...
- `CharacterDesign/MCP/RESULTS/CHAR05_04_IMPLEMENT_RUN_STATE_HUD_AND_PRESENTATION_BRIDGE_RESULT.md`
...
- 현재 TASK의 유일한 구현 목표는 ‘런 상태·인벤토리·HUD·애니메이션/사운드 이벤트 연결’이다.
...
RESULT PATH: `CharacterDesign/MCP/RESULTS/CHAR05_04_IMPLEMENT_RUN_STATE_HUD_AND_PRESENTATION_BRIDGE_RESULT.md`
...
권장 제목: `CHAR05_04: 런 상태·인벤토리·HUD·애니메이션/사운드 이벤트 연결`
