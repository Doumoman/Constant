...
- CHAR05_04 implemented run inventory/spend consumption, run status snapshot, HUD snapshot data bridge, and deterministic presentation event requests (request/data only)
- CHAR05_05 owns CHAR05 equipment/survival exit audit
- Counts after CHAR05_04 finalize: `21 COMPLETE / 0 CURRENT / 5 LOCKED`
