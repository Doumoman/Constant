...
- [>] `CHAR03_01_CONNECT_MAP_WORLD_QUERY_AND_BOUNDARY_GATE` — CURRENT: MAP 참조 가드 scope를 교정하고 MAP 좌표·월드 질의와 방 경계 준비 게이트를 연결한다.
- [ ] `CHAR03_02_IMPLEMENT_CAMERA_ROOM_TRANSITION_POLICY` — 카메라룸 전환·입력 KEEP·속도 KEEP·Hysteresis를 구현한다.
