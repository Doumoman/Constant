...
```text
TASKS/CHAR03_01_CONNECT_MAP_WORLD_QUERY_AND_BOUNDARY_GATE.md
```
...
```text
REPORTS/CHAR02_03_CHAR02_MOVEMENT_RULE_EXIT_AUDIT_RESULT.md
```
...
- CHAR03_01 Initial Result: BLOCKED
- CHAR03_01 Initial Blocker: obsolete CHAR01-era test guard forbids all Game.Map references while CHAR03_01 correctly requires Game.Map.Runtime
- CHAR03_01 Repair Scope: update dependency guard write scope, then implement MAP coordinate/query and readiness gate
...
- CHAR03_01 owns MAP coordinate/query contract connection and room boundary readiness gate
- CHAR03_02 owns camera room transition, input/velocity KEEP application details, and hysteresis
- Counts after repair patch apply: `10 COMPLETE / 1 CURRENT / 15 LOCKED`
