...
```text
TASKS/CHAR02_02_VALIDATE_THREE_CELL_FAILURE_AND_FORBIDDEN_MOVEMENT.md
```
...
| CHAR02_02_VALIDATE_THREE_CELL_FAILURE_AND_FORBIDDEN_MOVEMENT | CURRENT |
...
```text
CHAR02_01_VALIDATE_TWO_CELL_HEIGHT_AND_GAP_RULES
```
...
- CHAR02_02 owns same-level 3-cell gap failure and forbidden movement absence validation
- CHAR02_03 movement rule exit audit remains locked until separate patch
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03
- Counts after patch apply: `8 COMPLETE / 1 CURRENT / 17 LOCKED`
