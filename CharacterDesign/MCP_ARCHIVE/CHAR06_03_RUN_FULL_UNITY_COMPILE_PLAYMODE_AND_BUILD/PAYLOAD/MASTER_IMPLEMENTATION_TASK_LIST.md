...
| CHAR06 생성 맵·최종 검증 | 4 | 2 COMPLETE / 1 CURRENT / 1 LOCKED |
| **합계** | **26** | **24 COMPLETE / 1 CURRENT / 1 LOCKED** |
...
- [>] `CHAR06_03_RUN_FULL_UNITY_COMPILE_PLAYMODE_AND_BUILD` — CURRENT: 전체 compile·EditMode·PlayMode·build를 검증한다.
