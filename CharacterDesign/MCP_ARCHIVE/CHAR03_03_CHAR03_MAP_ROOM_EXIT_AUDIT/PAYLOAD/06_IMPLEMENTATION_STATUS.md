...
```text
TASKS/CHAR03_03_CHAR03_MAP_ROOM_EXIT_AUDIT.md
```
...
| CHAR03_03_CHAR03_MAP_ROOM_EXIT_AUDIT | CURRENT |
...
```text
CHAR03_02_IMPLEMENT_CAMERA_ROOM_TRANSITION_POLICY
```

## Last Result

```text
REPORTS/CHAR03_02_IMPLEMENT_CAMERA_ROOM_TRANSITION_POLICY_RESULT.md
```
...
- CHAR03_02 implemented camera-room transition policy, input KEEP, velocity KEEP, hysteresis, high-speed and airborne entry policy
...
- CHAR03_03 owns MAP/room integration exit audit
- Counts after patch apply: `12 COMPLETE / 1 CURRENT / 13 LOCKED`
