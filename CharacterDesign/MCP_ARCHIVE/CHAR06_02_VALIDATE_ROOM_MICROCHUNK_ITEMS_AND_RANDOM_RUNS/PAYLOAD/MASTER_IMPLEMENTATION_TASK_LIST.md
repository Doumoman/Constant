...
| CHAR06 생성 맵·최종 검증 | 4 | 1 COMPLETE / 1 CURRENT / 2 LOCKED |
| **합계** | **26** | **23 COMPLETE / 1 CURRENT / 2 LOCKED** |
...
- [>] `CHAR06_02_VALIDATE_ROOM_MICROCHUNK_ITEMS_AND_RANDOM_RUNS` — CURRENT: 방·마이크로청크·아이템·도구·무작위 런을 검증한다.
