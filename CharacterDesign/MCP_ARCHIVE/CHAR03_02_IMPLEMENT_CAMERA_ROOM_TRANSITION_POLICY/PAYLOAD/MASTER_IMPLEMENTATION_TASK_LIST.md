...
| CHAR03 MAP·방 전환 | 3 | 1 COMPLETE / 1 CURRENT / 1 LOCKED |
| CHAR04 상호작용·접촉 전투 | 4 | LOCKED |
| CHAR05 장비·생존·런 | 5 | LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **11 COMPLETE / 1 CURRENT / 14 LOCKED** |
...
- [>] `CHAR03_02_IMPLEMENT_CAMERA_ROOM_TRANSITION_POLICY` — CURRENT: 카메라룸 전환·입력 KEEP·속도 KEEP·Hysteresis를 구현한다.
