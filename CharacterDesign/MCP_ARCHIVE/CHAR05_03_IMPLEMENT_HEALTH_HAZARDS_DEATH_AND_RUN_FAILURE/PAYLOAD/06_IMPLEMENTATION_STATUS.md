...
| CHAR05_03_IMPLEMENT_HEALTH_HAZARDS_DEATH_AND_RUN_FAILURE | CURRENT |
...
```text
REPORTS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT_RESULT.md
```
...
- Current character EditMode tests after CHAR05_02: `134 PASS`
- CHAR05_03 owns health, hazards, death, and run failure requests
- CHAR05_04 owns run-state HUD and presentation bridge
- Counts after patch apply: `19 COMPLETE / 1 CURRENT / 6 LOCKED`
