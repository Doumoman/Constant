...
| CHAR05 장비·생존·런 | 5 | 2 COMPLETE / 1 CURRENT / 2 LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **19 COMPLETE / 1 CURRENT / 6 LOCKED** |
...
- [>] `CHAR05_03_IMPLEMENT_HEALTH_HAZARDS_DEATH_AND_RUN_FAILURE` — CURRENT: 체력·위험·사망·런 실패·복귀를 구현한다.
