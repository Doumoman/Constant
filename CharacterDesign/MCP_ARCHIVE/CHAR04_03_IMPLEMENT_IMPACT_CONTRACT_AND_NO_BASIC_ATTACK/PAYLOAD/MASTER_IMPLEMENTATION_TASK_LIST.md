...
| CHAR04 상호작용·접촉 전투 | 4 | 2 COMPLETE / 1 CURRENT / 1 LOCKED |
| CHAR05 장비·생존·런 | 5 | LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **15 COMPLETE / 1 CURRENT / 10 LOCKED** |
...
- [>] `CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK` — CURRENT: 투척·환경 충격 계약과 일반 공격 부재를 검증한다.
