...
```text
TASKS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK.md
```
...
| CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK | CURRENT |
...
```text
REPORTS/CHAR04_02_IMPLEMENT_STOMP_STUN_REMOVAL_AND_CONTACT_DAMAGE_RESULT.md
```
...
- Current character EditMode tests after CHAR04_02: `100 PASS`
- CHAR04_03 owns thrown-object impact contract, solid-world impact contract, owner grace suppression, and no-basic-attack validation
- CHAR04_04 owns CHAR04 interaction/combat exit audit
- Counts after patch apply: `15 COMPLETE / 1 CURRENT / 10 LOCKED`
