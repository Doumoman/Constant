...
| CHAR01 핵심 이동 | 4 | 1 COMPLETE / 1 CURRENT / 2 LOCKED |
...
| **합계** | **26** | **4 COMPLETE / 1 CURRENT / 21 LOCKED** |
...
- [>] `CHAR01_02_IMPLEMENT_COLLISION_QUERIES_AND_GROUND_MOTOR` — CURRENT: 충돌 질의·지지체·걷기·달리기·가감속을 구현한다.
