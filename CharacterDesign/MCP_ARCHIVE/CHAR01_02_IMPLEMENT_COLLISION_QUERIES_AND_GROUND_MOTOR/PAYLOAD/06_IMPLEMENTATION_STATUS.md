...
```text
TASKS/CHAR01_02_IMPLEMENT_COLLISION_QUERIES_AND_GROUND_MOTOR.md
```
...
| CHAR01_02_IMPLEMENT_COLLISION_QUERIES_AND_GROUND_MOTOR | CURRENT |
...
```text
CHAR01_01_IMPLEMENT_INPUT_SNAPSHOT_AND_PLAYER_STATES
```
...
- Active character runtime now exists under `Assets/_Game/Character/Runtime/**`
- Active character EditMode tests now exist under `Assets/_Game/Tests/EditMode/Character/**`
- Approved assemblies: `Game.Character.Runtime`, `Game.Character.Tests.EditMode`
- CHAR01_02 owns collision query abstraction, grounded detection, and horizontal ground motor
- Jump velocity, gravity, air control, landing, and 2-cell/3-cell course validation remain locked until later tasks
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03
- Counts after patch apply: `4 COMPLETE / 1 CURRENT / 21 LOCKED`
