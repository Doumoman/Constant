...
```yaml
patch_id: CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES
patch_version: 2.0
revision_note: CHAR05 EXIT 승인 기준선을 검증하고 CHAR06_01 generated map/player integration task 하나만 연다.
requires_status:
  current_task: NONE
...
requires_result:
  path: CharacterDesign/MCP/REPORTS/CHAR05_05_CHAR05_EQUIPMENT_SURVIVAL_EXIT_AUDIT_RESULT.md
  exact_status: PASS
  required_text:
    ...
    - "LOCKED 유지"
  sha256: cb7f4d136e6ff09183065754f4a22a1da4deab1311c80c7e205489e7cb0b17a6
requires_previous_task_file:
  path: CharacterDesign/MCP/TASKS/CHAR05_05_CHAR05_EQUIPMENT_SURVIVAL_EXIT_AUDIT.md
...
current_task_payload:
  path: PAYLOAD/TASKS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES.md
  sha256: b85b6097dbeb1fcef04343e8e8d78010ca2852fe821e5cce162808f28abd58c1
status_payload:
  path: PAYLOAD/06_IMPLEMENTATION_STATUS.md
  sha256: 82a572f784dcd0dc71d319155f52b71cb462c110f8f958387fa67e8b8b179957
master_payload:
  path: PAYLOAD/MASTER_IMPLEMENTATION_TASK_LIST.md
  sha256: adff93de3adec2def466ef44436841d49da4c1f1207aa36d3c04746a477c0be8
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 26
  status_counts_after_apply: 22 COMPLETE / 1 CURRENT / 3 LOCKED
  ...
  required_char06_01_editmode_tests: 12
  required_after_apply_character_editmode_tests: 170
forbids_started_task_prefixes:
  - CHAR06_02
  - CHAR06_03
  - CHAR06_04
sets_current_task: TASKS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES.md
    destination: CharacterDesign/MCP/TASKS/CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES.md
    mode: create
...
- CHAR05_05 Task와 REPORT, source registry의 hash와 marker가 일치한다.
- CHAR05_05 REPORT에 `STATUS: PASS`, `CHAR05_EXIT_DECISION: APPROVED`, `Current Task after finalize: NONE`, CHAR06_01 LOCKED 유지 문구가 있다.
- 새 payload 3개의 hash가 manifest와 일치한다.
- 적용 후 CHAR06_01만 CURRENT이며 CHAR06_02 이후는 LOCKED다.
