...
| CHAR06 생성 맵·최종 검증 | 4 | 1 CURRENT / 3 LOCKED |
| **합계** | **26** | **22 COMPLETE / 1 CURRENT / 3 LOCKED** |
...
- [>] `CHAR06_01_INTEGRATE_PLAYER_WITH_GENERATED_MAP_AND_ROUTES` — CURRENT: 생성 맵 시작·필수·선택 경로와 플레이어를 통합한다.
