...
```text
TASKS/CHAR00_03_CHAR00_BASELINE_EXIT_AUDIT.md
```
...
| CHAR00_03_CHAR00_BASELINE_EXIT_AUDIT | CURRENT |
...
```text
CHAR00_02_LOCK_GAMEPLAY_CONTRACTS_AND_TEST_FIXTURES
```
...
- Counts after patch apply: `2 COMPLETE / 1 CURRENT / 23 LOCKED`
