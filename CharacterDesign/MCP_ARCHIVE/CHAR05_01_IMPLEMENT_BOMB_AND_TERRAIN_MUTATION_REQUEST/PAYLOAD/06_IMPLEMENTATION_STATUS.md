...
| CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST | CURRENT |
...
```text
REPORTS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT_RESULT.md
```
...
- CHAR04_01 implemented carryable query, single carry slot, safe drop, directional throw, and owner collision grace request policy
- CHAR04_02 implemented stomp, stun, removal, rebound, and player contact damage candidates
- CHAR04_03 implemented thrown-object impact contract, solid-world impact contract, owner grace suppression, and no-basic-attack validation
- CHAR04_04 approved CHAR04 interaction/combat exit
...
- Current character EditMode tests after CHAR04_04: `110 PASS`
- CHAR05_01 owns bomb placement/fuse/explosion, terrain mutation request, and explosion damage candidates
- CHAR05_02 owns rope climbing and traversal support
- Counts after patch apply: `17 COMPLETE / 1 CURRENT / 8 LOCKED`
