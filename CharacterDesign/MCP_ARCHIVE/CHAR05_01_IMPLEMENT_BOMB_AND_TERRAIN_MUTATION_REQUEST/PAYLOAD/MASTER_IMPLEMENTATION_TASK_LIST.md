...
| CHAR05 장비·생존·런 | 5 | 1 CURRENT / 4 LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **17 COMPLETE / 1 CURRENT / 8 LOCKED** |
...
- [>] `CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST` — CURRENT: 폭탄·폭발 피해·MAP 지형 변경 요청을 구현한다.
