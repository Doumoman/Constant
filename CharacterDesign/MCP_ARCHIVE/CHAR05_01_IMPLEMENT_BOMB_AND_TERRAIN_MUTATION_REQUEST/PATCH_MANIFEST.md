...
```yaml
patch_id: CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST
patch_version: 2.0
revision_note: CHAR04 EXIT 승인 기준선을 검증하고 CHAR05_01 bomb/terrain mutation request task 하나만 연다.
requires_status:
  current_task: NONE
...
requires_result:
  path: CharacterDesign/MCP/REPORTS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT_RESULT.md
  exact_status: PASS
  required_text:
    ...
    - "LOCKED 유지"
  sha256: fc0fde8fc75d170f6eafd8436f5e21fb49b2b2b2990fba1bcb75c47ba5b38ab2
requires_previous_task_file:
  path: CharacterDesign/MCP/TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
  sha256: d87add58019b97ea23e2156bf309d5d651932cf9f0e03279283c7f120166e348
requires_input:
...
current_task_payload:
  path: PAYLOAD/TASKS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST.md
  sha256: a12be0d748a606f3c08c9267199bf2e7b74f92002e4ce316c73c63970c406d12
status_payload:
  path: PAYLOAD/06_IMPLEMENTATION_STATUS.md
  sha256: ea7e2bcdd18b1b8436ab0589378769e06b01e9bf356389c2ee80bb3cb3074aa5
master_payload:
  path: PAYLOAD/MASTER_IMPLEMENTATION_TASK_LIST.md
  sha256: 30b28eddb7be641a12f150e839fdec4b005e0968780d17dc716bca3888ece6a8
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 26
  status_counts_after_apply: 17 COMPLETE / 1 CURRENT / 8 LOCKED
  active_character_runtime: Game.Character.Runtime
  active_character_tests: Game.Character.Tests.EditMode
  required_existing_character_editmode_tests: 110
  required_char05_01_editmode_tests: 12
  required_after_apply_character_editmode_tests: 122
forbids_started_task_prefixes:
  ...
  - CHAR05_05
  - CHAR06
sets_current_task: TASKS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST.md
    destination: CharacterDesign/MCP/TASKS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST.md
    mode: create
...
- CHAR04_04 Task와 REPORT, source registry의 hash와 marker가 일치한다.
- CHAR04_04 REPORT에 `STATUS: PASS`, `CHAR04_EXIT_DECISION: APPROVED`, `Current Task after finalize: NONE`, CHAR05_01 LOCKED 유지 문구가 있다.
- 새 payload 3개의 hash가 manifest와 일치한다.
- 적용 후 CHAR05_01만 CURRENT이며 CHAR05_02 이후는 LOCKED다.
