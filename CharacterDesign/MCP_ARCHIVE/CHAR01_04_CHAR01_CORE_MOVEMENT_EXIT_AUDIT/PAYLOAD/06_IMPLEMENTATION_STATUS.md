...
```text
TASKS/CHAR01_04_CHAR01_CORE_MOVEMENT_EXIT_AUDIT.md
```
...
| CHAR01_04_CHAR01_CORE_MOVEMENT_EXIT_AUDIT | CURRENT |
...
- CHAR01 implemented input snapshot/buffer/state, collision query/ground motor, jump/air/landing
- CHAR02 movement course validation remains locked until separate patch
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03
- Counts after patch apply: `6 COMPLETE / 1 CURRENT / 19 LOCKED`
