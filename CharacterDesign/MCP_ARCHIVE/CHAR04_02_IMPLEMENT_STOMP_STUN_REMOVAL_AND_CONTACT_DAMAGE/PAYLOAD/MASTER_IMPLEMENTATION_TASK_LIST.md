...
| CHAR04 상호작용·접촉 전투 | 4 | 1 COMPLETE / 1 CURRENT / 2 LOCKED |
| CHAR05 장비·생존·런 | 5 | LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **14 COMPLETE / 1 CURRENT / 11 LOCKED** |
...
- [>] `CHAR04_02_IMPLEMENT_STOMP_STUN_REMOVAL_AND_CONTACT_DAMAGE` — CURRENT: 밟기·기절·제거·측면 접촉 피해를 구현한다.
