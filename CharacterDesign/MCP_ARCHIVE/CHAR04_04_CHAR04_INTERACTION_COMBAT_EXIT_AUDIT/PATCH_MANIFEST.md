...
```yaml
patch_id: CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT
patch_version: 2.0
revision_note: CHAR04_03 PASS/finalize 기준선을 검증하고 CHAR04_04 exit audit task 하나만 연다.
requires_status:
  current_task: NONE
...
requires_result:
  path: CharacterDesign/MCP/REPORTS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK_RESULT.md
  exact_status: PASS
  required_text:
    - "Current Task after finalize: NONE"
    - "CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT"
    - "LOCKED 유지"
  sha256: 14752158017446a9f49ff4c7088fdeb043b6886b9bfa48d60f378fe5ba85c1ab
requires_previous_task_file:
  path: CharacterDesign/MCP/TASKS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK.md
...
current_task_payload:
  path: PAYLOAD/TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
  sha256: d87add58019b97ea23e2156bf309d5d651932cf9f0e03279283c7f120166e348
status_payload:
  path: PAYLOAD/06_IMPLEMENTATION_STATUS.md
  sha256: 968a3ec4af0c419e9eac1a5f32620995a370ede4579e3baf45a04e4358fa6ea0
master_payload:
  path: PAYLOAD/MASTER_IMPLEMENTATION_TASK_LIST.md
  sha256: 116a44688e60cdbd71ce375bcea638766af9d288283776ddedadd1f79456a824
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 26
  status_counts_after_apply: 16 COMPLETE / 1 CURRENT / 9 LOCKED
  ...
  required_char04_04_editmode_tests: 0
  required_after_apply_character_editmode_tests: 110
forbids_started_task_prefixes:
  - CHAR05
  - CHAR06
sets_current_task: TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
    destination: CharacterDesign/MCP/TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
    mode: create
...
- CHAR04_03 Task와 REPORT, source registry의 hash와 marker가 일치한다.
- CHAR04_03 REPORT에 `STATUS: PASS`, `Current Task after finalize: NONE`, CHAR04_04 LOCKED 유지 문구가 있다.
- 새 payload 3개의 hash가 manifest와 일치한다.
- 적용 후 CHAR04_04만 CURRENT이며 CHAR05 이후는 LOCKED다.
