...
| CHAR04 상호작용·접촉 전투 | 4 | 3 COMPLETE / 1 CURRENT |
| CHAR05 장비·생존·런 | 5 | LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **16 COMPLETE / 1 CURRENT / 9 LOCKED** |
...
- [>] `CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT` — CURRENT: 상호작용·접촉 전투 전체를 감사한다.
