...
```text
TASKS/CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT.md
```
...
| CHAR04_04_CHAR04_INTERACTION_COMBAT_EXIT_AUDIT | CURRENT |
...
```text
REPORTS/CHAR04_03_IMPLEMENT_IMPACT_CONTRACT_AND_NO_BASIC_ATTACK_RESULT.md
```
...
- Current character EditMode tests after CHAR04_03: `110 PASS`
- CHAR04_04 owns CHAR04 interaction/combat exit audit only
- CHAR05_01 owns bomb, explosion, and terrain mutation request
- Counts after patch apply: `16 COMPLETE / 1 CURRENT / 9 LOCKED`
