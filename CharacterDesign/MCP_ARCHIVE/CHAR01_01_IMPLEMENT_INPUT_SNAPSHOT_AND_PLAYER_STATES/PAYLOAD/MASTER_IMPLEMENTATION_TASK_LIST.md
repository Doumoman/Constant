...
| CHAR01 핵심 이동 | 4 | 1 CURRENT / 3 LOCKED |
...
| **합계** | **26** | **3 COMPLETE / 1 CURRENT / 22 LOCKED** |
...
- [>] `CHAR01_01_IMPLEMENT_INPUT_SNAPSHOT_AND_PLAYER_STATES` — CURRENT: 논리 입력 스냅샷·버퍼와 플레이어 상태를 구현한다.
