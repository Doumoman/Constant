...
| CHAR01 핵심 이동 | 4 | 2 COMPLETE / 1 CURRENT / 1 LOCKED |
...
| **합계** | **26** | **5 COMPLETE / 1 CURRENT / 20 LOCKED** |
...
- [>] `CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING` — CURRENT: 점프·가변 높이·코요테·공중 제어·착지를 구현한다.
