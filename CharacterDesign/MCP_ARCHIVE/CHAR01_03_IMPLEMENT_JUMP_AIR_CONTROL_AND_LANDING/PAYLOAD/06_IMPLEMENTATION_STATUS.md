...
```text
TASKS/CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING.md
```
...
| CHAR01_03_IMPLEMENT_JUMP_AIR_CONTROL_AND_LANDING | CURRENT |
...
- CHAR01_02 provided collision query abstraction, ground probe, and horizontal ground motor
- CHAR01_03 owns jump buffer, coyote time, jump start, variable jump release, air control, gravity/fall clamp, and landing state transition
- 2-cell/3-cell course validation remains locked until CHAR02
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03
- Counts after patch apply: `5 COMPLETE / 1 CURRENT / 20 LOCKED`
