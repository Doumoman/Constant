...
```text
TASKS/CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW.md
```
...
| CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW | CURRENT |
...
```text
REPORTS/CHAR03_03_CHAR03_MAP_ROOM_EXIT_AUDIT_RESULT.md
```
...
- CHAR03 completed MAP/room integration audit
...
- CHAR04_01 owns carryable query, pickup, safe drop, directional throw, and owner collision grace request policy
- CHAR04_02 owns stomp, stun, removal, and contact damage
- CHAR04_03 owns impact contract and no-basic-attack validation
- Counts after patch apply: `13 COMPLETE / 1 CURRENT / 12 LOCKED`
