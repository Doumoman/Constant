...
| CHAR04 상호작용·접촉 전투 | 4 | 1 CURRENT / 3 LOCKED |
| CHAR05 장비·생존·런 | 5 | LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **13 COMPLETE / 1 CURRENT / 12 LOCKED** |
...
- [>] `CHAR04_01_IMPLEMENT_CARRY_DROP_AND_DIRECTIONAL_THROW` — CURRENT: 단일 휴대·안전 내려놓기·방향 투척을 구현한다.
