...
- [>] `CHAR02_03_CHAR02_MOVEMENT_RULE_EXIT_AUDIT` — CURRENT: 코요테 3셀 통과 blocker를 교정하고 이동 문법 전체를 재감사한다.
