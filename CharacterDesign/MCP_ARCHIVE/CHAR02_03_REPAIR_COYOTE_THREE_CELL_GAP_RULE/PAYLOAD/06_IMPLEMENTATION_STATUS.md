...
```text
TASKS/CHAR02_03_CHAR02_MOVEMENT_RULE_EXIT_AUDIT.md
```
...
- CHAR02_03 Initial Result: FAIL
- CHAR02_03 Initial Finding: legal coyote delayed jump clears same-level 3-cell gap
- CHAR02_03 Repair Scope: movement tuning/coyote repair plus repair regressions, then rerun exit audit
- CHAR01 EXIT: APPROVED
- CHAR02_01 validated 2-cell height reach and same-level 2-cell gap pass
- CHAR02_02 validated same-level 3-cell basic-path failure and forbidden movement absence
...
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03 only if CHAR02 exit is approved
- Counts after repair patch apply: `9 COMPLETE / 1 CURRENT / 16 LOCKED`
