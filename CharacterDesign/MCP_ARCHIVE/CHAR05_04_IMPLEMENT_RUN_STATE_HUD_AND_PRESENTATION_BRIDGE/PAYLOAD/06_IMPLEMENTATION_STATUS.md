...
| CHAR05_04_IMPLEMENT_RUN_STATE_HUD_AND_PRESENTATION_BRIDGE | CURRENT |
...
```text
REPORTS/CHAR05_03_IMPLEMENT_HEALTH_HAZARDS_DEATH_AND_RUN_FAILURE_RESULT.md
```
...
- Current character EditMode tests after CHAR05_03: `146 PASS`
- CHAR05_04 owns run state, HUD snapshot, and presentation event request bridge
- CHAR05_05 owns CHAR05 equipment/survival exit audit
- Counts after patch apply: `20 COMPLETE / 1 CURRENT / 5 LOCKED`
