...
| CHAR05 장비·생존·런 | 5 | 3 COMPLETE / 1 CURRENT / 1 LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **20 COMPLETE / 1 CURRENT / 5 LOCKED** |
...
- [>] `CHAR05_04_IMPLEMENT_RUN_STATE_HUD_AND_PRESENTATION_BRIDGE` — CURRENT: 런 상태·인벤토리·HUD·프레젠테이션 이벤트를 연결한다.
