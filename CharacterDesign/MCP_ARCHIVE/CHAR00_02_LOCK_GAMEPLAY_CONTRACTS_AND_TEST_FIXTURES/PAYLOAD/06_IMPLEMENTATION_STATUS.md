...
```text
TASKS/CHAR00_02_LOCK_GAMEPLAY_CONTRACTS_AND_TEST_FIXTURES.md
```
...
| CHAR00_02_LOCK_GAMEPLAY_CONTRACTS_AND_TEST_FIXTURES | CURRENT |
...
```text
CHAR00_01_INVENTORY_CHARACTER_INPUT_PHYSICS_MAP
```
...
- MAP coordinate contract exists; character query/mutation/room readiness APIs remain future dependencies
- Counts after patch apply: `1 COMPLETE / 1 CURRENT / 24 LOCKED`
