...
```yaml
patch_id: CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT
patch_version: 2.0
revision_note: CHAR05_01 PASS/finalize 기준선을 검증하고 CHAR05_02 rope traversal task 하나만 연다.
requires_status:
  current_task: NONE
...
requires_result:
  path: CharacterDesign/MCP/REPORTS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST_RESULT.md
  exact_status: PASS
  required_text:
    - "Current Task after finalize: NONE"
    - "CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT"
    - "LOCKED 유지"
  sha256: 1c5036404d957cc5ca534d4c0ec89e77995c3d6adfa66306b73915bc42005e7f
requires_previous_task_file:
  path: CharacterDesign/MCP/TASKS/CHAR05_01_IMPLEMENT_BOMB_AND_TERRAIN_MUTATION_REQUEST.md
...
current_task_payload:
  path: PAYLOAD/TASKS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT.md
  sha256: 0ba1e7c1b3b41e76419fb477a071dfd25226de02f7808ea4030b7c64c8198d8b
status_payload:
  path: PAYLOAD/06_IMPLEMENTATION_STATUS.md
  sha256: 500e6ea26981ff3abc130c10f5ad71eba7aff9be98e585cbd62e9782e3645378
master_payload:
  path: PAYLOAD/MASTER_IMPLEMENTATION_TASK_LIST.md
  sha256: 26598cb875f8589348bd61656e97f8a57749d0d7802b1b84e6ec91d62869e6ba
requires_project_baseline:
  unity: 6000.3.8f1
  master_tasks: 26
  status_counts_after_apply: 18 COMPLETE / 1 CURRENT / 7 LOCKED
  active_character_runtime: Game.Character.Runtime
  active_character_tests: Game.Character.Tests.EditMode
  required_existing_character_editmode_tests: 122
  required_char05_02_editmode_tests: 12
  required_after_apply_character_editmode_tests: 134
forbids_started_task_prefixes:
  - CHAR05_03
  - CHAR05_04
  - CHAR05_05
  - CHAR06
sets_current_task: TASKS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT.md
copy_operations:
  ...
  - source: PAYLOAD/06_IMPLEMENTATION_STATUS.md
    ...
    mode: replace
  - source: PAYLOAD/TASKS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT.md
    destination: CharacterDesign/MCP/TASKS/CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT.md
    mode: create
...
- CHAR05_01 Task와 REPORT, source registry의 hash와 marker가 일치한다.
- CHAR05_01 REPORT에 `STATUS: PASS`, `Current Task after finalize: NONE`, CHAR05_02 LOCKED 유지 문구가 있다.
- 새 payload 3개의 hash가 manifest와 일치한다.
- 적용 후 CHAR05_02만 CURRENT이며 CHAR05_03 이후는 LOCKED다.
