...
| CHAR05 장비·생존·런 | 5 | 1 COMPLETE / 1 CURRENT / 3 LOCKED |
| CHAR06 생성 맵·최종 검증 | 4 | LOCKED |
| **합계** | **26** | **18 COMPLETE / 1 CURRENT / 7 LOCKED** |
...
- [>] `CHAR05_02_IMPLEMENT_ROPE_CLIMBING_AND_TRAVERSAL_SUPPORT` — CURRENT: 로프 설치·등반·경계 제한을 구현한다.
