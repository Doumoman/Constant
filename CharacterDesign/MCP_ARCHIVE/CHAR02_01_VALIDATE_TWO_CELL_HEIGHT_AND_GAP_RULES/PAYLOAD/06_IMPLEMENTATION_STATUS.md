...
```text
TASKS/CHAR02_01_VALIDATE_TWO_CELL_HEIGHT_AND_GAP_RULES.md
```
...
| CHAR02_01_VALIDATE_TWO_CELL_HEIGHT_AND_GAP_RULES | CURRENT |
...
- CHAR02_01 owns fixed EditMode course validation for 2-cell height reach and same-level 2-cell gap pass
- 3-cell gap failure and forbidden movement validation remain locked until CHAR02_02
- MAP world query/mutation/boundary/readiness APIs remain deferred to CHAR03
- Counts after patch apply: `7 COMPLETE / 1 CURRENT / 18 LOCKED`
